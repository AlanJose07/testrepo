    ...
    overrides: {
		...
		onValidate: function(type, args) {
			if(this.data.js.name=="Incident.Subject"){
				var subject_value = this.input.get('value');
		...
		if(subject_value == "Your Beachbody Customer Coach Change Request"){
			if(membertypeid == 771){
				var checkBox1 = document.getElementById("RESULT_CheckBox-21_0"); //english
				if(checkBox1.checked == false){
					customValidationFlag = 1;	
					errors.push('La "Case de Permission" est requis pour soumettre cette demande'); 
				}
			}
		}
		else if(subject_value == "Your Beachbody Preferred Customer Coach Change Request"){
				var checkBox1 = document.getElementById("RESULT_CheckBox-21_0"); //english
				if(checkBox1.checked == false){
					customValidationFlag = 1;	
					errors.push('La "Case de Permission" est requis pour soumettre cette demande'); 

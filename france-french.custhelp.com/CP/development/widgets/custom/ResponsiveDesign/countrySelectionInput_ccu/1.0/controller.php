...
class countrySelectionInput_ccu extends \RightNow\Widgets\SelectionInput {
			  ...
			  $i=0;
                    foreach ($items as $item) {
                       ...
                       //$tempItems[$item->ID] = $item->LookupName ?: $item->Name;
							   ...
							   $menuItems=array("1"=>"US","2"=>"Canada","7"=>"United Kingdom"); //this will be uncommented once the uk changes go live on 2017-10-19 [by jithin]
							   //$menuItems=array("1"=>"US","2"=>"Canada"); // this will be removed once UK go live on 2017-10-19 [by jithin] 

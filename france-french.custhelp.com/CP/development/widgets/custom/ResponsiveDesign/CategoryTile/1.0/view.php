...
<? if($this->data['attrs']['page']=="2" and $this->data['attrs']['interface']=="31") :?>

 
		<? $categ_id=$this->data['categ_id']; ?>
		<? $cat_id_name=$this->data['categ_id'].".".$this->data['cat_nme'];?>
		
		<rn:widget path="custom/ResponsiveDesign/Popular_answer_count" static_filter="c=#rn:php:$cat_id_name#" report_id="146110"/>

...
class CategoryTile extends \RightNow\Libraries\Widget\Base {
    ...
    function getData() {
		...
		if($text->count()>0)
	   {
		...
		{
		 $query="select BB.categ_contac_hom_fra from BB.categ_contac_hom_fra where BB.categ_contac_hom_fra.visible_on_page.ID=".$page_id." and BB.categ_contac_hom_fra.enable=1 and BB.categ_contac_hom_fra.interface.ID=".$interface_id." ORDER BY BB.categ_contac_hom_fra.display_order";  
		}
		else                // else condition for the contact us flow
		{
		 
		 $query="select BB.categ_contac_hom_fra from BB.categ_contac_hom_fra where BB.categ_contac_hom_fra.visible_on_page.ID=".$page_id." and BB.categ_contac_hom_fra.category.Parent.ID=".$cat_id." and BB.categ_contac_hom_fra.enable=1 and BB.categ_contac_hom_fra.interface.ID=".$interface_id." ORDER BY BB.categ_contac_hom_fra.display_order";
		}

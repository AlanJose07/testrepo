...
<script>
  ...
  if ( historyTraversal ) {
    // Handle page restore.
	document.getElementById("rn_ChatLaunchForm").reset();
  }
});
</script> 
...
<form id="rn_ChatLaunchForm" method="post" action="">
		...
		<div class="overlay-form" id="self-service">
		 ...
		 <h1 id="phone-title" style="display:none">Appeler l’assistance</h1>
		...
		<rn:widget path="custom/ResponsiveDesign/MemberType" name="Incident.c$member_type_new" label_input="Type d’abonnement" required="true" label_required="Obligatoire" />
		</div>
		...
		<rn:widget path="custom/ResponsiveDesign/CustomFileAttachmentUpload" label_input="Joindre des Documents"/>
		</div>

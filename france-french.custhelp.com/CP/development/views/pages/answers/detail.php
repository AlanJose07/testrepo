  ...
  <div class="container">
    ...
    <div class="rn_AnswerDetail">
	  ...
	  <!-- <rn:widget path="custom/ResponsiveDesign/AnswerFeedbackReason" dialog_threshold="1" label_dialog_description  ="Please select what best describes the information: " submit_feedback_ajax="/cc/AjaxCustom/submitAnswerFeedback" label_dialog_title=""/>-->
	    <rn:widget path="custom/ResponsiveDesign/AnswerFeedback" dialog_threshold="1" label_dialog_description  ="Sélectionnez l’option décrivant le mieux les informations:" submit_feedback_ajax="/cc/AjaxCustom/submitAnswerFeedback" label_dialog_title="" label_cancel_button="Annuler" label_no_button="Non" label_feedback_thanks="Merci pour votre avis" label_send_button="Envoyer" label_title="Cette réponse a-t-elle été utile ?" label_yes_button="Oui"/>
      </div>
    </div>
  </div>
</div>

    ...
    <div id="rn_ChatContainer">
        <div id="rn_PageContent" class="rn_Live">
            <div class="rn_Padding">
					...
					<div id="rn_ChatDialogTitle" class="rn_FloatLeft">Veuillez vous connecter pour discuter avec un agent.<!--#rn:msg:CHAT_LBL#--></div>
					</rn:condition>
		...
		<div id="popup-message-loggedin"  style="text-align: center;display: none;">
		 ...
		 <rn:widget path="chat/ChatStatus" label_chat_available="Horaires d'ouverture du service client par chat" />
		 <rn:widget path="custom/ResponsiveDesign/ChatHoursPrechat" label_chat_hours =""/>  
		 </div>

...
?>
<div class="success-txt">Merci ! La mise à jour de votre formulaire de consentement a été traitée.</div>
<div id="extraInfo"> <span>Le Numéro de Référence: <?php echo $ref; ?></span></div>
<?      }
     }
		else
		{ 

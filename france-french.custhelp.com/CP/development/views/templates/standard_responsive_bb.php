	  ...
	  <div class="login-btn-custom sign-in">
        ...
        <nav style="text-align:left;">
          <ul>
            ...
            <li><a href="https://coach.teambeachbody.com/frfr/" onClick="click_tracking('Menu Links - Coach Office')">Bureau du coach</a></li>
            <li><a href="https://www.teambeachbody.com/shop/coach" onClick="click_tracking('Menu Links - Become Coach')">Devenir Coach</a></li>
            <li><a href="https://beachbodyondemand.com/groups" onClick="click_tracking('Menu Links - BODgroups')">BODgroups</a></li>    
            <li><a href="https://www.teambeachbody.com/shop/" onClick="click_tracking('Menu Links - Shop')">Acheter</a></li> 
			...
			<span class="c-button c-button--dropdown js-dropdown__current"><img src="/euf/assets/themes/responsive/images/france.png" id="selectedFlag">FRANCE (FRANÇAIS)</span>
...
<section class="banner inner-banner">
  ...
  <div class="container-fluid">
    <div class="inner-nav row d-none">
      ...
      <div class="container"> 
	  <rn:condition show_on_pages="home">
	  <a class="navbar-brand">Assistance</a>
	  </rn:condition>
	   <rn:condition hide_on_pages="home">
	  <a class="navbar-brand" href="/app/home" onClick="click_tracking('Assistance')">Assistance</a>
	  </rn:condition>
        <nav>
  ...
  <span class="right-bar"></span>
          ...
          <ul id="nav_ul">
			...
			<? if ($home) { ?>
				<a href="/app/contactus" class="nav_link" id="gethelplink" onClick="click_tracking('ENVOYEZ UN EMAIL')">CONTACTER l’ASSISTANCE</a>
			<? } else {  ?>
				<a href="/app/contactus" class="nav_link"  onClick="click_tracking('ENVOYEZ UN EMAIL')">ENVOYEZ UN EMAIL</a>
			<? } ?>
			</rn:condition>
			</li>
            <li class="nav_li"><a href="#" class="nav_link">
           <div class="c-dropdown js-dropdown">
                ...
                <ul class="c-dropdown__list">
                  ...
                  <li  onclick="location.href='https://faq.beachbody.ca/app/home';" class="c-dropdown__item" data-dropdown-value="UK" imageName ="/euf/assets/themes/responsive/images/ca.png"><img src="/euf/assets/themes/responsive/images/ca.png">CANADA (ENGLISH)</li>
				  
				  <li onClick="location.href='https://faq.fr.beachbody.ca';" class="c-dropdown__item" data-dropdown-value="Canada" imageName ="/euf/assets/themes/responsive/images/ca.png"><img src="/euf/assets/themes/responsive/images/ca.png">CANADA (FRANÇAIS)</li>
				  
                  <li onClick="location.href='https://faq.beachbody.co.uk/app/home';" class="c-dropdown__item" data-dropdown-value="Canada" imageName ="/euf/assets/themes/responsive/images/uk.png"><img src="/euf/assets/themes/responsive/images/uk.png">UK (ENGLISH)</li>
				  
				  <li  onclick="location.href='/app/home';" class="c-dropdown__item" data-dropdown-value="FRANCE" imageName ="/euf/assets/themes/responsive/images/france.png"><img src="/euf/assets/themes/responsive/images/france.png">FRANCE (FRANÇAIS)</li>
	...
	<rn:condition logged_in="false">
      <h1>Bienvenue sur l’Assistance Beachbody  </h1>
	  <rn:condition_else/>
	   <h1><?php echo "Bonjour ".$this->session->getProfile()->first_name->value.",  Bienvenue sur l’Assistance Beachbody " ?></h1>
	   </rn:condition>
  ...
  <div class="container opa-footer-fix-container">
    <div class="row">
	 <rn:condition show_on_pages="home,gethelp,answers/detail,answers/list,answers/most_popular_answers">
      ...
      <a href="/app/contactus" onClick="click_tracking('Envoyez un Email')">Envoyez un Email</a> 
...
$(document).ready(function(){
		...
		policyLink.attr('href', 'https://www.teambeachbody.com/shop/fr/privacy?locale=fr_FR');
		...
		if (window.Osano) {
			 window.Osano.cm.addEventListener("osano-cm-initialized", function (consentObject) {
				...
				//var cookiesText = 'Gérer les cookies';

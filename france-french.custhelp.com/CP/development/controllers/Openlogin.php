 ...
 /**
	...
	logmessage("_authorizeBeachbody");
            ...
            $parameters = array(
				...
				'redirect_uri'=>'https://france-french--tst2.custhelp.com/cc/openlogin/oauth/callback/beachbody',
	...
	$redirect_rul=urlencode("https://france-french--tst2.custhelp.com/cc/openlogin/oauth/callback/beachbody");
	$count = 0;
	 if($requestToken){
	 load_curl();
	 $code_verifier = $this->session->getSessionData('code_verifier');

...

{
	...
	*/
	 function CreateEmailLabel()
    {
		...
		$shiplabel = $this->model('custom/ShippingLabelCOModal')->insert($_GET,'FEDEX',$_GET['contactid']);
		$id= $shiplabel['id'];
		...
		$request['WebAuthenticationDetail'] = array(
				...
				try {
					...
					if ($response['HighestSeverity'] != 'FAILURE' && $response['HighestSeverity'] != 'ERROR'){
						...
						$this->model('custom/ShippingLabelCOModal')->updateErrorStatus($id,json_encode($response['Notifications']));
...
function getProperty($var){
  ...
  if($var == 'key') Return 'eWMXlyEJqdyrLqJW'; 
	if($var == 'password') Return '7LCD3fksknAiOlFeqOpo8tLGV'; 
	if($var == 'parentkey') Return 'eWMXlyEJqdyrLqJW'; 
	if($var == 'parentpassword') Return '7LCD3fksknAiOlFeqOpo8tLGV'; 
	if($var == 'shipaccount') Return '143259862';
	if($var == 'billaccount') Return '143259862';
	if($var == 'dutyaccount') Return '143259862'; 
	if($var == 'freightaccount') Return '143259862';  
	if($var == 'trackaccount') Return '143259862'; 
	if($var == 'dutiesaccount') Return '143259862';
	if($var == 'importeraccount') Return '143259862';
	if($var == 'brokeraccount') Return '143259862';
	if($var == 'distributionaccount') Return '143259862';

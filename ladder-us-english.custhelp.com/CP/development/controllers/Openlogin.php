...
use RightNow\Utils\Text,
	...
	RightNow\Connect\Crypto\v1_3 as Crypto;
...

{
 ...
 /**
	...
	logmessage("_authorizeBeachbody");
            ...
            $parameters = array(
                'client_id'=>'824f8e5c-5fd3-4ac8-a19b-479c277af8b6',
				'redirect_uri'=>'https://faq.beachbody.com/cc/openlogin/oauth/callback/beachbody',
	...
	$redirect_rul=urlencode("https://faq.beachbody.com/cc/openlogin/oauth/callback/beachbody");
	$count = 0;
	 if($requestToken){
	 load_curl();
	 $code_verifier = $this->session->getSessionData('code_verifier');
	 ...
	 //$error_url = '/app/signing'; header('Location: ' . $error_url); exit;
          ...
          while($count < 3){
            //get FB access token
           $response = $this->client->post('https://login.beachbody.com/03ed5554-4840-327e-9346-6e5c74000000/login/token', array(
                'code' => $requestToken,
                'client_id' => '824f8e5c-5fd3-4ac8-a19b-479c277af8b6',

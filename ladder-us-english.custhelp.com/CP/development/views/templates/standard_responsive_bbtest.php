<?
 ...
 ?>
 <script>
 //localStorage.setItem("service_alert_session", 1);
 </script>
<?php

//---for get quick answer link--//
$home = ($this->uri->router->segments[3] == "hometest");
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-1 col-sm-1">
        <div class="logo"><a href="https://faq.beachbody.com/app/hometest"> <img src="/euf/assets/themes/responsive/images/logo.png"></a></div>
      </div>
...
<rn:condition show_on_pages="hometest">
<section class="banner">
</rn:condition>
<rn:condition hide_on_pages="hometest">
<section class="banner inner-banner">
  ...
  <div class="container-fluid">
    <div class="inner-nav row">
	  ...
	  <a class="navbar-brand">Support</a>
	   ...
	   <rn:condition hide_on_pages="hometest">
	  <a class="navbar-brand" href="https://faq.beachbody.com/app/hometest" onClick="click_tracking('Support')">Support</a>
	  </rn:condition>
        <nav>
  ...
  <span class="right-bar"></span>
          ...
          <ul id="nav_ul">
			...
			<? } else {  ?>
				<a href="/app/hometest/gethelp/1" class="nav_link"  onClick="click_tracking('Get Quick Answers')">GET QUICK ANSWERS</a>
			<? } ?>
			</li>
           ...
           <div class="c-dropdown js-dropdown">
                ...
                <ul class="c-dropdown__list">
                  ...
                  <li  onclick="location.href='https://faq.beachbody.com/app/hometest';" class="c-dropdown__item" data-dropdown-value="English" imageName ="/euf/assets/themes/responsive/images/us.png" ><img src="/euf/assets/themes/responsive/images/us.png">US</li>
				  
                  <li  onclick="location.href='https://faq.beachbody.ca/app/hometest';" class="c-dropdown__item" data-dropdown-value="UK" imageName ="/euf/assets/themes/responsive/images/ca.png"><img src="/euf/assets/themes/responsive/images/ca.png">CANADA</li>
				  
                  <li onClick="location.href='https://faq.beachbody.co.uk/app/hometest';" class="c-dropdown__item" data-dropdown-value="Canada" imageName ="/euf/assets/themes/responsive/images/uk.png"><img src="/euf/assets/themes/responsive/images/uk.png">UK</li>
...
<rn:condition hide_on_pages="hometest,contactus">
...
<footer>
  <div class="container">
    <div class="row">
	 <rn:condition show_on_pages="hometest,gethelp,answers/detail,answers/list,answers/list_generic,answers/most_popular_answers">

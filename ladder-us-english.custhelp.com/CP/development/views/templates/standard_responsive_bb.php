...
if($contactus_support == "contactus" || $contactus_support == "contactus_support")
{
	    $url = "/app/home";
 		header('Location: ' . $url);
}
...
})(window,document,'script','https://cdn.decibelinsight.net/i/13996/612547/di.js','decibelInsight');
// ]]>
</script>
<!-- Decibel - help.ladder.sport -->
...
<rn:widget path="custom/ResponsiveDesign/ErrorRedirection" />
  ...
  <link type="text/css" rel="stylesheet" href="/euf/assets/themes/standard/ladder_site.css" />	

  <!--ADD TO HOME SCREEN-->
  
 	  <link rel="icon" type="image/png" sizes="16x16"  href="/euf/assets/themes/mobile/images/myxfit_icon.png">
...
<body class="v-scroll">
  ...
  <div class="full-wrapper">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
			 ...
			 <a class="redirect_logo" href="/app/home" alt="Ladder"><img src="/euf/assets/themes/responsive/images/ladder_logo.png"></a>
			 </div>	
		  <nav>	
		  <div class="header_wrapper">	
		  <rn:condition show_on_pages="home">
           <div class="header_logo"><img src="/euf/assets/themes/responsive/images/ladder_logo.png"></div>	
          </rn:condition>
          <rn:condition hide_on_pages="home">
			...
			<!--	
			 <ul class="header_link_wrapp">	
			 <li><a class="header_link" href="https://ladder.sport/my-account/subscriptions/"> Manage Subscriptions </a></li>	
			 <li><a class="header_link"  href="https://ladder.sport/">Shop</a></li>	
			 <li >	
			  <a  href="/app/contactus" class="header_link" id="gethelplink_mobile" onClick="click_tracking('CONTACT SUPPORT')">Email Us</a>	
    ...
    <rn:condition hide_on_pages="home">
      <section class="banner inner-banner banner-reset">
    </rn:condition>
    ...
    <div class="container-fluid">
        ...
        <div class="container">
         ...
         <!-- <rn:condition hide_on_pages="contactus,contactus_support,contactus_sub_level,chat_mobile">
            ...
            <ul id="nav_ul">
                ...
                <rn:condition hide_on_pages="contactus,contactus_support,contactus_sub_level,chat_mobile">
                  <? if ($home) { ?>
                    <a href="/app/contactus" class="nav_link" id="gethelplink" onClick="click_tracking('CONTACT SUPPORT')">Email Us</a>
                  <? } else {  ?>
                    <a href="/app/contactus" class="nav_link" onClick="click_tracking('CONTACT SUPPORT')">Email Us</a>
                  <? } ?>
                </rn:condition>
              </li>
     ...
     <rn:condition logged_in="false">
          <h1>Welcome to LADDER Support</h1>
          <rn:condition_else />
          <h1><?php echo "Hi " . $this->session->getProfile()->first_name->value . ", Welcome to Ladder Support" ?></h1>
        </rn:condition>
          ...
          <form class="form-horizontal" onSubmit="return false;">
            <rn:container report_id="176">
              <div class="form-group form-group-md">
                <rn:widget path="custom/ResponsiveDesign/KeywordText" label_text="" label_placeholder="Enter a question or keyword" initial_focus="false" />
   ...
   <div class="container-footer">	
	...
	<!--	  <rn:condition show_on_pages="home,gethelp,answers/detail,answers/list,answers/list_generic,answers/most_popular_answers">
				  <div class="cont-button-new-contactus">
					  ...
					  <a href="/app/contactus" onClick="click_tracking('Contact Us')">Email Us</a> 
		...
		<div class="container">
					...
					<div class="footer_container">
						...
						<div class="footer-ul ">
									<ul class="first-child">
										  <li><p class="ladder_footer_text">Company</p></li>
										  <li><a href="https://ladder.sport/pages/about-us/">About Us</a></li>
										  <li><a href="https://ladder.sport/fine-print/privacy-policy/">Privacy Policy</a></li>
									  
									</ul>
						</div>
						<div class="social-icons"> 
							<p class="ladder_followus">Follow Us:</p>
							<a target="_blank" class="social-icon" href="https://www.instagram.com/laddersport/" alt="Ladder">
							<img src="/euf/assets/themes/responsive/images/instagram_icon.svg#instagram-usage" alt=""/> </a>
							
							<a target="_blank" class="social-icon" href="https://www.facebook.com/laddersport/" alt="Ladder">
							<img src="/euf/assets/themes/responsive/images/facebook.svg#facebook-usage" alt=""/> </a>
						
							<a target="_blank" class="social-icon" href="https://twitter.com/laddersport/" alt="Ladder">
							<img src="/euf/assets/themes/responsive/images/twitter_icon.svg#twitter-usage" alt=""/> </a>
						</div>
			...
			<div class="border_footer_top">
				<div class="row">
					<div class="col-md-12">
						<div class="all_rights_warpper">
							<p class="footer_text">© 2022 Openfit, LLC. All rights reserved. Openfit, LLC is the owner of the Openfit and Ladder trademarks, and all related designs, trademarks, copyrights, and other intellectual property. All other trademarks are the property of their respective owners.</p>
						</div>
					</div>
				</div>
			</div>
...
<script>
  ...
  $(".trial-butn").click(function() {
  	window.location.href = "https://www.myxfitness.com/products/the-myx/";
  });
   });
...
$(document).ready(function() {
	$('#do_not_sell_my_info').click(function(){
		...
		console.log(jQuery('.osano-cm-storage-policy'));
		policyLink.eq(1).attr('href', 'https://www.openfit.com/fine-print/privacy-policy/'); 

RightNow.namespace('Custom.Widgets.input.TextInput_French_CCF_Other');
Custom.Widgets.input.TextInput_French_CCF_Other = RightNow.Widgets.TextInput.extend({ 
    /**
	...
	*/
	...
	ShowOtherContinuedService: function(type, args)
	{
		...
		if(other_service == true)
		{
			...
			labelnew.innerHTML="S'il vous plaît spécifier et énumérer toutes les cases "+"<span class='rn_Required'> *</span>  <font color='#696969' size='-1' class='example'>e.g. Pro Team, 3-jours Refresh</font> ";
	...
	*/
	...
	ShowOtherReasonForCancellation: function(type, args)
	{
		...
		if(other_reason == "Autres")
		{
			
			document.getElementById("other_reason").style.display = "block";
			var labelnew = document.getElementById("rn_" + this.instanceID + "_" + "Label");
			labelnew.innerHTML="Veuillez préciser "+"<span class='rn_Required'> *</span>";
			this.data.attrs.required=true;
		}
		else
		{

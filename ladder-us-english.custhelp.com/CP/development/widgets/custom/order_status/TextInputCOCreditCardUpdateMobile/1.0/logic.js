...
RightNow.namespace('Custom.Widgets.order_status.TextInputCOCreditCardUpdateMobile');
Custom.Widgets.order_status.TextInputCOCreditCardUpdateMobile = RightNow.Field.extend({
    overrides: {
    ...
    onValidate: function(type, args) {
		...
		var email = (document.getElementsByName("CO.order_tracking_new.email")[2].value).trim();
		...
		if(this._fieldName == 'email')
		{
		 ...
		 var zip_code = (document.getElementsByName("CO.order_tracking_new.zip_code")[2].value).trim();

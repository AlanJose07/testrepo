...
RightNow.namespace('Custom.Widgets.order_status.TextInputCOCreditCardUpdate');
Custom.Widgets.order_status.TextInputCOCreditCardUpdate = RightNow.Field.extend({
    overrides: {

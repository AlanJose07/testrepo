...
RightNow.namespace('Custom.Widgets.order_status.TextInputCO_Request');
Custom.Widgets.order_status.TextInputCO_Request = RightNow.Field.extend({
    overrides: {
        constructor: function(data, instanceID) {
			...
			if(this._fieldName == "email")
			{
				...
				document.getElementById(field_id).placeholder="Email";
			...
			if(this._fieldName == "zip_code")
			{
				...
				var field_id = "rn_" + this.instanceID + "_CO.order_tracking_new"+"."+this._fieldName;
				document.getElementById(field_id).placeholder="Zip / Post / Postal Code";
			...
			if(this._fieldName == "order_number")
			{
				...
				var field_id = "rn_" + this.instanceID + "_CO.order_tracking_new"+"."+this._fieldName;
				document.getElementById(field_id).placeholder="Order Number";
    ...
    onValidate: function(type, args) {
		...
		var email = (document.getElementsByName("CO.order_tracking_new.email")[1].value).trim();
		...
		if(this._fieldName == 'email')
		{
		 ...
		 var zip_code = (document.getElementsByName("CO.order_tracking_new.zip_code")[1].value).trim();
		 var order_number = (document.getElementsByName("CO.order_tracking_new.order_number")[0].value).trim();
		  
		   var country_id=document.getElementsByName("Contact.Address.Country")[1].value;//new
		 ...
		 */ 
		 if(zip_code == "" && order_number=="" && email == "" && country_id==0)
		 {
    ...
    _displayError: function(errors, errorLocation,email_zip_err_flag) {
        ...
        if(commonErrorDiv) {
			...
			{
				//message_err = "<b>Please fill either Order Number Or Email and Zip Code";//edited by Vimal on 10/6/2016
				message_err = "<b>Please fill Country/Pais/Pays, Order Number Or Email and Zip / Post / Postal Code";//new
				document.getElementsByName("CO.order_tracking_new.zip_code")[0].className='rn_Text rn_ErrorField';
			}
			else if(email_zip_err_flag == 2)
			{
				//message_err = "<b>Please fill both Email and Zip Code";//Old commented by Vimal on 10/6/2016
				message_err = "<b>Please fill either Order Number Or Email";	
				document.getElementsByName("CO.order_tracking_new.zip_code")[0].className='rn_Text rn_ErrorField';
			}
			
			else if(email_zip_err_flag == 3)//Added by Vimal on 10/6/2016
			{
			...
			else if(email_zip_err_flag == 4)//new
			{
				...
				document.getElementsByName("Contact.Address.Country")[1].className='rn_Text rn_ErrorField';
			}

...
<?php
	...
	//=================================================================
	//die("-------------------------------".$this->data["js"]["category_id_sixth"]);
		//OTHER VARIABLES 
		...
		elseif( (strpos( $uri, "home" ) !== false) || (strpos( $uri, "gethelp" ) !== false)  ):
			...
			$rootPageLabel="Browse FAQs by Topic";
		...
		?>
		<div class="breadcrumb-container test"> <span class="breadcrumb"> <a href="<?=$rootPageUrl?>"><?=$rootPageLabel?></a> </span>
				
		<?php
		if($mostPopularAnswersLabel!=""):
		?>
		 <span class="breadcrumb test"><a href="<?=$subPageUrl.$catId.$mostpopularCatname.$tileTextVar;?>"> <?php echo $catName;?> </a> </span>
		 <?php echo $mostPopularAnswersLabel;?> 
		...
		?>
		<label class="breadcrumb test1"><?php echo $catName;?></label> 
		<?php
		endif;
		?>

   ...
   _onFormValidated: function() {
    ...
    _confirmOnNavigate : function(result){
		 ...
		 if(checked_channel=="1530")
		 {
				...
				div.innerHTML += "<div class='email-conf-title'><h2>Your request was successfully submitted.</h2></div><div class='email-conf-cont'><div>Thanks for reaching out to Ladder. We make every effort to reply to emails within 4 hours. If your request comes in after 5pm PT we will reply the next morning.</div><div> You may use this reference number for follow up:&nbsp;<b>"+incident_ref_no+"</b></div></div>";

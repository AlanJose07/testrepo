...
Custom.Widgets.ResponsiveDesign.TextInput = RightNow.Widgets.TextInput.extend({ 
    ...
    overrides: {
		...
		/* 		if(fieldName=="Incident.Subject")
			{
				subject="";
	            if(this.data.js.category_name_sixth)
				{
					subject=subject+this.data.js.category_name_sixth + " >> ";
				}
				if(this.data.js.category_name_fifth)
				{
					subject=subject+this.data.js.category_name_fifth + " >> ";
				}
				if(this.data.js.category_name_fourth)
				{
					subject=subject+this.data.js.category_name_fourth + " >> ";
				}
				if(this.data.js.category_name_third)
				{
					subject=subject+this.data.js.category_name_third + " >> ";
				}
				if(this.data.js.category_name_second)
				{
					subject=subject+this.data.js.category_name_second + " >> ";
	
				}
				if(this.data.js.category_name_first)
				{
					subject=subject+this.data.js.category_name_first + " >> ";
				}
				if(this.data.js.catname)
				{
					subject=subject+this.data.js.catname;
				}

				document.getElementById("rn_" + this.instanceID + '_'+this.data.js.name).value=subject;
				document.getElementById("rn_" + this.instanceID).className+=" is-completed";

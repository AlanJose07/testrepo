...
<head>
	...
	<rn:widget path="utils/AdvancedSecurityHeaders" content_type_options='nosniff' xss_protection=1
		content_security_policy="script-src 'unsafe-inline' 'unsafe-eval'; style-src * 'unsafe-inline'; default-src 'self'; object-src 'none'; child-src 'self'; upgrade-insecure-requests" />
...
// ]]>
	...
	<link rel="shortcut icon" type="image/png" sizes="192x192"
		href="/euf/assets/themes/mobile/images/BB_Support_Stacked_192x192_Blue.png">


	<link rel="apple-touch-icon" sizes="192x192"
		href="/euf/assets/themes/mobile/images/BB_Support_Stacked_192x192_Blue.png">
	<link rel="apple-touch-icon" sizes="180x180"
		href="/euf/assets/themes/mobile/images/BB_Support_Stacked_180x180_Blue.png">
	<link rel="apple-touch-icon" sizes="152x152"
		href="/euf/assets/themes/mobile/images/BB_Support_Stacked_152x152_Blue.png">
	<link rel="apple-touch-icon" sizes="144x144"
		href="/euf/assets/themes/mobile/images/BB_Support_Stacked_144x144_Blue.png">
	<link rel="apple-touch-icon" sizes="120x120"
		href="/euf/assets/themes/mobile/images/BB_Support_Stacked_120x120_Blue.png">
	<link rel="apple-touch-icon" sizes="114x114"
		href="/euf/assets/themes/mobile/images/BB_Support_Stacked_144x144_Blue.png">

	<link rel="apple-touch-icon" sizes="76x76"
		href="/euf/assets/themes/mobile/images/BB_Support_Stacked_76x76_Blue.png">
	<link rel="apple-touch-icon" sizes="72x72"
		href="/euf/assets/themes/mobile/images/BB_Support_Stacked_72x72_Blue.png">
	<link rel="apple-touch-icon" sizes="60x60"
		href="/euf/assets/themes/mobile/images/BB_Support_Stacked_60x60_Blue.png">

	<link rel="apple-touch-icon" sizes="58x58"
		href="/euf/assets/themes/mobile/images/BB_Support_Stacked_58x58_Blue.png">
	<link rel="apple-touch-icon" sizes="57x57"
		href="/euf/assets/themes/mobile/images/BB_Support_Stacked_57x57_Blue.png">
	...
	<link rel="icon" type="image/png" sizes="96x96"
		href="/euf/assets/themes/mobile/images/BB_Support_Stacked_96x96_Blue.png">
	<link rel="icon" type="image/png" sizes="58x58"
		href="/euf/assets/themes/mobile/images/BB_Support_Stacked_58x58_Blue.png">
	<link rel="icon" type="image/png" sizes="57x57"
		href="/euf/assets/themes/mobile/images/BB_Support_Stacked_57x57_Blue.png">
	<link rel="icon" type="image/png" sizes="32x32"
		href="/euf/assets/themes/mobile/images/BB_Support_Stacked_32x32_Blue.png">
	<link rel="icon" type="image/png" sizes="16x16"
		href="/euf/assets/themes/mobile/images/BB_Support_Stacked_16x16_Blue.png">
	...
	<link rel="apple-touch-icon-precomposed" sizes="58x58"
		href="/euf/assets/themes/mobile/images/BB_Support_Stacked_58x58_Blue.png">
	...
	<style>
		...
		.hamburger-menu nav ul li a .c-button--dropdown:hover,
		.hamburger-menu nav ul li a .c-button--dropdown:hover:after {
			color: #fff;
		}
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 col-sm-12 col-lg-1 col-xs-12 txt-center-mob-tab">
						<div class="logo"><a href="/app/home"> <img
									src="/euf/assets/themes/responsive/images/logo.png"></a></div>
					</div>
					<div class="col-md-12 col-sm-12 col-lg-11 col-xs-12 ">
						<div class="login-btn-custom sign-in">

							<rn:condition logged_in="false">
								<rn:widget path="custom/ResponsiveDesign/OverridedOpenLogin"
									sub_id='#rn:php:"openlogin_$provider"#' display_in_dialog="false" />
								<? /* Attributes Default to Facebook */?>

							</rn:condition>
							<div class="sign-out-mobile">
								<rn:condition logged_in="true">
									<rn:widget path="custom/ResponsiveDesign/CustomLogoutLink" Label="Sign Out"
										id="logout" />
								</rn:condition>
							</div>
						</div>
						...
						<div class="my-order-btn">
							<a href="https://www.teambeachbody.com/shop/us/account/settings?tab=MyOrders"
								onClick="click_tracking('Menu Links - My Orders')">My Orders</a>
						</div>

						<div class="menu-tigger"> <span></span> <span></span> <span></span> </div>
						<nav>
							<ul>
								<li><a href="https://www.beachbodyondemand.com/"
										onClick="click_tracking('Menu Links - BOD')">Beachbody On Demand</a></li>
								<li><a href="https://coach.teambeachbody.com/engb/sign-in-uk"
										onClick="click_tracking('Menu Links - Coach Office')">Coach Office</a></li>
								<li><a href="https://www.teambeachbody.com/shop/gb/coach?locale=en_GB&destPage=coach"
										onClick="click_tracking('Menu Links - Become Coach')">Become a Coach</a></li>
								<li><a href="https://beachbodyondemand.com/groups"
										onClick="click_tracking('Menu Links - BODgroups')">BODgroups</a></li>
								<li><a href="https://community.beachbody.com/s/"
										onClick="click_tracking('Menu Links - Community')">Community</a></li>
								<li><a href="https://www.teambeachbody.com/shop/gb/b"
										onClick="click_tracking('Menu Links - Shop')">Shop</a></li>
								<li class="hide-mobile-only"><a
										href="https://www.teambeachbody.com/shop/us/account/settings?tab=MyOrders"
										onClick="click_tracking('Menu Links - My Orders')">My Orders</a></li>
								...
								<li class="nav_li"><a href="#" class="nav_link">
										<div class="c-dropdown js-dropdown">
											...
											<span class="c-button c-button--dropdown js-dropdown__current"><img
													src="/euf/assets/themes/responsive/images/uk.png"
													id="selectedFlag">UK (ENGLISH)</span>
											<ul class="c-dropdown__list">

												<li onclick="location.href='https://us-english--tst2.custhelp.com/app/home';"
													class="c-dropdown__item" data-dropdown-value="English"
													imageName="/euf/assets/themes/responsive/images/us.png"><img
														src="/euf/assets/themes/responsive/images/us.png">US (ENGLISH)
												</li>

												<li onclick="location.href='https://us-spanish--tst2.custhelp.com/app/home';"
													class="c-dropdown__item" data-dropdown-value="Spanish"
													imageName="/euf/assets/themes/responsive/images/us.png"><img
														src="/euf/assets/themes/responsive/images/us.png">US (ESPAÑOL)
												</li>

												<li onclick="location.href='https://canada-english--tst2.custhelp.com/app/home';"
													class="c-dropdown__item" data-dropdown-value="Canada"
													imageName="/euf/assets/themes/responsive/images/ca.png"><img
														src="/euf/assets/themes/responsive/images/ca.png">CANADA
													(ENGLISH)</li>

												<li onclick="location.href='https://canada-french--tst2.custhelp.com/app/home';"
													class="c-dropdown__item" data-dropdown-value="Canada"
													imageName="/euf/assets/themes/responsive/images/ca.png"><img
														src="/euf/assets/themes/responsive/images/ca.png">CANADA
													(FRANÇAIS)</li>

												<li onClick="location.href='https://uk-english--tst2.custhelp.com/app/home';"
													class="c-dropdown__item" data-dropdown-value="UK"
													imageName="/euf/assets/themes/responsive/images/uk.png"><img
														src="/euf/assets/themes/responsive/images/uk.png">UK (ENGLISH)
												</li>

												<li onClick="location.href='https://france-french--tst2.custhelp.com/app/home';"
													class="c-dropdown__item" data-dropdown-value="FRANCE"
													imageName="/euf/assets/themes/responsive/images/france.png"><img
														src="/euf/assets/themes/responsive/images/france.png">FRANCE
													(FRANÇAIS)</li>
											</ul>
										</div>
									</a></li>
				...
				<div class="container">
					...
					<nav>
						...
						<ul id="nav_ul">
							<li class="nav_li">
								<rn:condition
									hide_on_pages="contactus,contactus_support,contactus_sub_level,chat_mobile">
									<? if ($home) { ?>
										<a href="/app/contactus" class="nav_link" id="gethelplink"
											onClick="click_tracking('CONTACT SUPPORT')">CONTACT SUPPORT</a>
									<? } else { ?>
										<a href="/app/contactus" class="nav_link"
											onClick="click_tracking('CONTACT SUPPORT')">CONTACT SUPPORT</a>
									<? } ?>
								</rn:condition>
							</li>
							<li class="nav_li"><a href="#" class="nav_link">
									<div class="c-dropdown js-dropdown">
										...
										<img src="" id="selectedFlag">
										<span class="c-button c-button--dropdown js-dropdown__current"><img
												src="/euf/assets/themes/responsive/images/uk.png" id="selectedFlag">UK
											(ENGLISH)</span>
										<ul class="c-dropdown__list">


											<li onclick="location.href='https://faq.beachbody.com/app/home';"
												class="c-dropdown__item" data-dropdown-value="English"
												imageName="/euf/assets/themes/responsive/images/us.png"><img
													src="/euf/assets/themes/responsive/images/us.png">US (ENGLISH)</li>

											<li onclick="location.href='https://faq.es.beachbody.com/app/home';"
												class="c-dropdown__item" data-dropdown-value="Spanish"
												imageName="/euf/assets/themes/responsive/images/us.png"><img
													src="/euf/assets/themes/responsive/images/us.png">US (ESPAÑOL)</li>

											<li onclick="location.href='https://faq.beachbody.ca/app/home';"
												class="c-dropdown__item" data-dropdown-value="Canada"
												imageName="/euf/assets/themes/responsive/images/ca.png"><img
													src="/euf/assets/themes/responsive/images/ca.png">CANADA (ENGLISH)
											</li>

											<li onclick="location.href='https://faq.fr.beachbody.ca/app/home';"
												class="c-dropdown__item" data-dropdown-value="Canada"
												imageName="/euf/assets/themes/responsive/images/ca.png"><img
													src="/euf/assets/themes/responsive/images/ca.png">CANADA (FRANÇAIS)
											</li>

											<li onClick="location.href='https://faq.beachbody.co.uk/app/home';"
												class="c-dropdown__item" data-dropdown-value="UK"
												imageName="/euf/assets/themes/responsive/images/uk.png"><img
													src="/euf/assets/themes/responsive/images/uk.png">UK (ENGLISH)</li>

											<li onClick="location.href='https://faq.beachbody.fr/app/home';"
												class="c-dropdown__item" data-dropdown-value="FRANCE"
												imageName="/euf/assets/themes/responsive/images/france.png"><img
													src="/euf/assets/themes/responsive/images/france.png">FRANCE
												(FRANÇAIS)</li>
	  ...
	  <option value='uk' data-image="/euf/assets/themes/responsive/images/gb.svg" >UK</option>
			...
			<div class="banner-ontents">
				<rn:condition logged_in="false">
					...
					<rn:condition_else />
					<h1>
						<?php echo "Hi " . $this->session->getProfile()->first_name->value . ", Welcome to Beachbody Support" ?>
					</h1>
				</rn:condition>
						...
						<rn:container report_id="176">
							<div class="form-group form-group-md">
								<rn:widget path="search/KeywordText" label_text=""
									label_placeholder="Enter a question or FAQ#" initial_focus="false" />
				...
				<? if ($ip_check == 'FR' || $ip_check == 'GB'): ?>
					<? if ($cookie_consent): ?>
						...
						<div class="manage-cookies-opa-fix">
							<a href="javascript:void(0);" class="manage-cookies"
								onClick="click_tracking('Manage Cookies')">Manage Cookies</a>
						</div>
					<? endif; ?>
				<? endif; ?>
...
<script>
	...
	$(document).ready(function () {
		...
		policyLink.attr('href', 'https://www.teambeachbody.com/shop/gb/privacy?locale=en_GB');

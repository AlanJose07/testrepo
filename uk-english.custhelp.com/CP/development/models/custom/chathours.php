   ...
   function getChatHours($chat)
	{ 
		...
		try{
			...
			$rmas = RNCPHP\ROQL::queryObject("SELECT CO.CustomChatHours FROM CO.CustomChatHours WHERE CO.CustomChatHours.ID = 12")->next();     
			$rma = $rmas->next();
			//echo "<pre>";
			//print_r($rma);
			...
			// No SMS channel for UK interface as of July 10, 2020

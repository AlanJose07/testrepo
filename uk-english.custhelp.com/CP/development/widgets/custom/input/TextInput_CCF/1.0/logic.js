RightNow.namespace('Custom.Widgets.input.TextInput_CCF');
Custom.Widgets.input.TextInput_CCF = RightNow.Widgets.TextInput.extend({ 
    /**
	...
	//var empty_string_ie = "data:image/jpeg;base64,";
		...
		else
		{
			...
			var c2 = document.getElementById("previewImage");
...
html2canvas(element, 
 {
 	onrendered: function (canvas) 
	{
       ...
       $("#previewImage").append(canvas);
	  	convertToImg(canvas); // function call
    }	 
 });//html2canvas
...
if((document.getElementById("html-content-holder").value==='') || (SignatureTextValue.substring(0,3)!=="/s/") ||(SignatureTextValue.length <= 3))
	...
	*/
	...
	_displayErrorSignature: function(errors, errorLocation) {
        ...
        if(commonErrorDiv) {
            for(var i = 0, errorString = "", message, id = "html-content-holder"; i <errors.length; i++) {
				...
				var message = "Please sign document";
	...
	/*
	*Displays error message if Terms of Cancellation is not agreed
	*/
        ...
        if(commonErrorDiv) {
            for(var i = 0, errorString = "", message, id = "terms_of_cancellation"; i < errors.length; i++) {
				...
				var message = "In order to submit the form please check all the Terms of Cancellation";

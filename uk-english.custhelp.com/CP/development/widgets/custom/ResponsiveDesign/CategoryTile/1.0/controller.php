...
class CategoryTile extends \RightNow\Libraries\Widget\Base
{
	...
	function getData()
	{
		...
		{
			$query = "select BB.categ_contac_hom_uk from BB.categ_contac_hom_uk where BB.categ_contac_hom_uk.visible_on_page.ID=" . $page_id . " and BB.categ_contac_hom_uk.enable=1 and BB.categ_contac_hom_uk.interface.ID=" . $interface_id . " ORDER BY BB.categ_contac_hom_uk.display_order";
		} else                // else condition for the contact us flow
		{

			$query = "select BB.categ_contac_hom_uk from BB.categ_contac_hom_uk where BB.categ_contac_hom_uk.visible_on_page.ID=" . $page_id . " and BB.categ_contac_hom_uk.category.Parent.ID=" . $cat_id . " and BB.categ_contac_hom_uk.enable=1 and BB.categ_contac_hom_uk.interface.ID=" . $interface_id . " ORDER BY BB.categ_contac_hom_uk.display_order";
		}

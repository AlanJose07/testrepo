...
<div id="rn_<?=$this->instanceID;?>" class="rn_KeywordText">
	...
	<?php if( $this->data['clang']=="ko_KR" && $this->data['flgtNo']=="DAL"){?>
	  <input id="rn_<?=$this->instanceID;?>_Text" name="rn_<?=$this->instanceID;?>_Text" type="text" maxlength="255" value="<?=$this->data['js']['initialValue'];?>" placeholder="키워드를 사용하거나 질문을 하여 자주 묻는 질문을 검색합니다."/>

...
<div id="rn_<?=$this->instanceID;?>" class="<?= $this->classList ?>">
    ...
    <h3><a href="<?=$this->data['attrs']['report_page_url'] . $this->data['appendedParameters'] .\RightNow\Utils\Url::sessionParameter(). "/{$this->data['type']}/" .$value['id']."/ge/1";?>"><?=htmlspecialchars($value['label'], ENT_QUOTES, 'UTF-8');?></a></h3>

...
RightNow.namespace('Custom.Widgets.reports.ResultInfoPrivate');
Custom.Widgets.reports.ResultInfoPrivate = RightNow.SearchFilter.extend({
    overrides: {
        constructor: function() {
            this.parent();
			RightNow.Event.subscribe("evt_srchRes", this._setvar, this);
	...
	_setvar: function(type,args) {
		
		document.getElementById("rn_ResultInfoPrivate_6_NoResults").style.display = "none";

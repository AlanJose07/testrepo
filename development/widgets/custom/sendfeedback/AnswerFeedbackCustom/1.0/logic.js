 /* Originating Release: November 2018 */
 RightNow.namespace('Custom.Widgets.sendfeedback.AnswerFeedbackCustom');
Custom.Widgets.sendfeedback.AnswerFeedbackCustom = RightNow.Widgets.extend({
    constructor: function() {
        this._dialog = this._keyListener = this._thanksLabel = null;
        this._rate = 0;
        var Event = this.Y.Event;
        //evt_setValueKeyword
        RightNow.Event.subscribe("evt_setValueKeyword", this.setkeyword, this);
     ...
     */
    setkeyword: function(type,args)
    {
        //console.log(args[0]);
        this.data.keyword=args[0].data.keyword;

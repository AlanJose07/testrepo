    ...
    <div class="header_logo">
	 ...
	 if($sla!=="AMCC"){?>
           <!-- <a href="https://gogoair.sharepoint.com/sites/excaretrain/SitePages/Home.aspx" target="_blank" class="all-page-logo"><img src="/euf/assets/themes/standardagent/images/gogo_sharepoint.png" alt="Gogo SharePoint"/></a> -->
			<a href="https://startek-my.sharepoint.com/:x:/p/vanessa_lopez1/EYQR8K0ZjFhKn7o-uPllarcB125NlV__I2wbRTNWcG4xuw?rtime=fAkt9RkM2kg" target="_blank" class="all-page-logo"><img src="/euf/assets/themes/standardagent/images/spibug.png" alt="Known Issue"/></a>
			<?php }
			else
			{ ?>
			<a href="https://care.inflightinternet.com/app/answers/list_amcc" target="_blank" class="nose">Nose/Tail look up</a>
			<a href="https://care.inflightinternet.com/app/answers/taillist" target="_blank" class="all-page-logo"><img src="/euf/assets/themes/standardagent/images/tail_list.png" height="105" width="88"/></a>
			<a href="https://care.inflightinternet.com/app/answers/flightschedule" target="_blank" class="white"><img src="/euf/assets/themes/standardagent/images/white.png" height="50" width="150"/></a>			
			<?php } ?>
       <!-- login -->
        ...
        <rn:condition show_on_pages="answers/list">

<!--
        <div class="gogole-image">
					<img src="/euf/assets/themes/standardagent/images/gogole-image.png" alt="Gogo Logo"/>
				</div>
-->
          </rn:condition>

...
--------------------------------------------------------------------------------------->						
							...
							// $nose=getUrlParm('n');
							?>
							<!-- <span id="nose" style="float: left;margin-left: 25px;margin-top: 16px;font-size: large;">-->
								<?php
								 // echo "Nose #: <label class='text-select-all'>". $nose; "</label>"
									?>
									<!-- </span> -->
							...
							<!-- <span id="tail" style="float: left;margin-left: 25px;margin-top: 16px;font-size: large;"> -->
								<?php 
								// echo "Tail: <label class='text-select-all'>". $tail; "</label>"
								?>
							<!-- </span>	 -->
							...
							// {
                               ...
                               <?php 
																															// echo "Aircraft Type: <label class='text-select-all'>". getUrlParm('a'); "</label>"
																															?>
							   ...
							   <?php
										 // echo "Technology: <label class='text-select-all'>". $tech; "</label>"
											?>                              
                                <!-- </span>	 -->
                                <?php 
																																// } 

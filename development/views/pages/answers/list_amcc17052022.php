...
?>     
    ...
    <div id="info">
        <div class="w_100">
            <div class="w_60">
                <div class="column" id="det" style="width:100%; height:550px;">
                    </div>
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200 && this.responseText!="") {
	  ...
	  var parsed_part = JSON.parse(this.responseText);
				...
				var myTable_part= "<table style='cellpadding:0;border-collapse: collapse;  border: 1px solid black; cellspacing:0;'><tr><td style='width: 50px;border: 1px solid black; text-align: center;background: #545454;padding: 5px;color:#fff;font-size:14px;'>Tail No</td>";
...
//				myTable_part+="<td style='width: 50px;border: 1px solid black;  text-align: center;background: #545454;padding: 5px;color:#fff;font-size:14px;'>Updated</td></tr>";
				myTable_part+="<td style='width: 50px;border: 1px solid black;  text-align: center;background: #545454;padding: 5px;color:#fff;font-size:14px;'>RMA#</td></tr>";
					...
					for(var j=0;j<prased_length;j++)
					{
						...
						myTable_part+="<tr><td style='width: 100px;border: 1px solid black; text-align: center;'>" + parsed_part[j]['u_incident'].u_tail_number + "</td>";
...
//				myTable_part+="<td style='width: 50px;border: 1px solid black;  text-align: center;background: #545454;padding: 5px;color:#fff;font-size:14px;'>Updated</td></tr>";
  ...
  xhttp.open("POST", "https://custhelp.gogoinflight.com/cgi-bin/aircell.cfg/php/custom/partsmovements.php", true);
  ...
  xhttp.send("keyword="+keyword);
            ...
            <div class="w_40">
				...
				<div class="column">
				<h1 align="center" style="font-size:20px;" id="partmovement_loading">Parts Movements Loading......</h1>
				<h1 align="center" style="font-size:20px; display:none" id="partmovement_heading">Parts Movements</h1>
                ...
                */
                ...
                <div class="column"><iframe src="https://custhelp.gogoinflight.com/cgi-bin/aircell.cfg/php/custom/snow-closed.php?tail=<?php echo $tail?>" width="100%" height="500" ></iframe></div>
            </div>
        </div>
        <div class="w_100">
...
function flightinfo() {
	...
	var keyword=array[1];	
	  ...
	  var xhr = new XMLHttpRequest();
	  var report_results;
  xhr.open("GET", "http://dataservices.fig.prods.gogoair.com/v1/flights?registration-number="+tailnum+"&status=current&detail=true");
	xhr.onload = function () {
  ...
  const map = new ol.Map({
	...
	var iconStyle = new ol.style.Style({
            image: new ol.style.Icon( /* @type {olx.style.IconOptions} */({
                ...
                anchorYUnits: 'pixels',
                src: 'https://custhelp.gogoinflight.com/euf/assets/images/dept2.png'
            }))
        });	
		var iconStyle3 = new ol.style.Style({
            image: new ol.style.Icon( /* @type {olx.style.IconOptions} */({
                ...
                anchorXUnits: 'fraction',
                anchorYUnits: 'pixels',
                src: 'https://custhelp.gogoinflight.com/euf/assets/images/arriv.png'
            }))
        });	
      ...
      const flightsSource = new ol.source.Vector({
            ...
            loader: function() {
                const url = 'https://custhelp.gogoinflight.com/dav/cp/customer/development/views/pages/config/flight.json';
                fetch(url)
                    ...
                    .then(function(json) {
                      ...
                      var iconStyle2 = new ol.style.Style({
                          image: new ol.style.Icon( /** @type {olx.style.IconOptions} */ ({
                              ...
                              anchorXUnits: 'fraction',
                              anchorYUnits: 'pixels',
                              src: 'https://custhelp.gogoinflight.com/euf/assets/images/planeloc2.png'
                          }))
                      });

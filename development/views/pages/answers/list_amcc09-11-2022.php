...
//				myTable_part+="<td style='width: 50px;border: 1px solid black;  text-align: center;background: #545454;padding: 5px;color:#fff;font-size:14px;'>Updated</td></tr>";
				myTable_part+="<td style='width: 50px;border: 1px solid black;  text-align: center;background: #545454;padding: 5px;color:#fff;font-size:14px;'>RMA#</td></tr>";
					...
					for(var j=0;j<prased_length;j++)
					{
						...
						myTable_part+="<td style='width: 100px;border: 1px solid black; text-align: center;'>" + parsed_part[j]['u_number'].display_value + "</td>";
...
//				myTable_part+="<td style='width: 50px;border: 1px solid black;  text-align: center;background: #545454;padding: 5px;color:#fff;font-size:14px;'>Updated</td></tr>";
				myTable_part+="<td style='width: 50px;border: 1px solid black;  text-align: center;background: #545454;padding: 5px;color:#fff;font-size:14px;'>RMA</td></tr>";
					myTable_part+="<tr><td colspan='7' style='width: 100px;border: 1px solid black; text-align: center;'>No Data Found</td></tr>";
					myTable_part+="</table>";
					document.getElementById('partmovement').innerHTML=myTable_part;
	}
  };
  ...
  const map = new ol.Map({
	...
	var iconStyle = new ol.style.Style({
            image: new ol.style.Icon( /* @type {olx.style.IconOptions} */({
                ...
                anchorYUnits: 'pixels',
                src: 'https://custhelp.gogoinflight.com/euf/assets/themes/standard/images/dept2.png'
            }))
        });	
		var iconStyle3 = new ol.style.Style({
            image: new ol.style.Icon( /* @type {olx.style.IconOptions} */({
                ...
                anchorXUnits: 'fraction',
                anchorYUnits: 'pixels',
                src: 'https://custhelp.gogoinflight.com/euf/assets/themes/standard/images/arriv.png'
            }))
        });	
      ...
      const flightsSource = new ol.source.Vector({
            ...
            loader: function() {
                const url = 'https://custhelp.gogoinflight.com/euf/assets/themes/standard/flight.json';
                fetch(url)
                    ...
                    .then(function(json) {
                      ...
                      var iconStyle2 = new ol.style.Style({
                          image: new ol.style.Icon( /** @type {olx.style.IconOptions} */ ({
                              ...
                              anchorXUnits: 'fraction',
                              anchorYUnits: 'pixels',
                              src: 'https://custhelp.gogoinflight.com/euf/assets/themes/standard/images/planeloc2.png'
                          }))
                      });

...
<?php
 ...
 if(getUrlParm('flightNumber') || getUrlParm('tailNumber'))
	...
	//mkt remove
	//$flgtNo = "AAL";
	//specialflag for loading different widget
	$aal_flag = 0;
	if($flgtNo=="AAL")
	{
		//$aal_flag = 1;
      ...
      <div class="rn_Padding_homepage">
        <div class="support_category">
	     ...
	     <?php }   ?> 
			...
			<?php } 
			elseif(strpos($flgtNo,'JAL')!== false||strpos($flgtNo,'AMX')!== false||strpos($flgtNo,'GLO')!== false||strpos($flgtNo,'G3')!== false|| strpos($flgtNo,'VIR')!== false|| strpos($flgtNo,'VOZ')!== false|| strpos($flgtNo,'JTA')!== false)
			{?>

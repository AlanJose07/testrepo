...
Custom.Widgets.ResponsiveDesign.FormSubmitOrderStatus = RightNow.Widgets.FormSubmit.extend({ 
    ...
    overrides: {
       ...
       RightNow.Event.subscribe("on_before_ajax_request", this._onBeforeAjaxRequest, this);
        ...
        if (!responseObject) { 
			...
			document.getElementById("errors").innerHTML ="<div><b>Por favor ingrese un número de orden válido o correo electrónico y Cremallera / Postal / código postal</b></div>";
			...
			if( (country_id==1) || (country_id==0) )//us
			{
				...
				document.getElementById("errors").innerHTML +=	"<div><b><a href='/app/contactus_support/catid/1749/catname/Track-My-Order/ans_sec/8443/TLP/1702.All-Orders-(Other-Nutritionals,-DVDs,-and-Apparel)' target='_blank' >chatear</a> <span>para asistencia</span></b></div>";
			...
			if(country_id==2)//canada
			{
				...
				document.getElementById("errors").innerHTML +=	"<div><b><a href='https://faq.beachbody.ca/app/contactus_support/catid/1749/catname/Track-My-Order/ans_sec/8443/TLP/1702.All-Orders-(Other-Nutritionals,-DVDs,-and-Apparel)' target='_blank' >chatear</a> <span>para asistencia</span></b></div>";
			...
			if(country_id==7)//uk
			{
				...
				document.getElementById("errors").innerHTML +=	"<div><b><a href='https://faq.beachbody.co.uk/app/contactus_support/catid/1749/catname/Track-My-Order/ans_sec/8443/TLP/1702.All-Orders-(Other-Nutritionals,-DVDs,-and-Apparel)' target='_blank' >chatear</a> <span>para asistencia</span></b></div>";
			...
			if( (country_id==1) || (country_id==0) )//us
			{
				//chat redirected to All Orders(Track my orders)
				//commented by sriram
				document.getElementById("errors").innerHTML +=	"<div><b><a href='/app/contactus_support/catid/1749/catname/Rastrear-Mi-Pedido/a_id/0/TLP/1702.Todos-Mis-Pedidos' target='_blank' >chatear</a> <span>para asistencia</span></b></div>";
				//document.getElementById("errors").innerHTML +=	"<div><b><a href='https://faq.beachbody.com/app/contactus_support/catid/1749/catname/Track-My-Order/ans_sec/8443/TLP/1702.All-Orders-(Other-Nutritionals,-DVDs,-and-Apparel)' target='_blank' >chatear</a> <span>para asistencia</span></b></div>";
	...
	getOrderStatus: function(responseObject) {
		...
		var title = "<div>ESTADO DE PEDIDO</div>";
		...
		*/
		...
		document.getElementById("valid_data").innerHTML ="<div class='shipped_order'><div>Su pedido "+responseObject.order_number+" para "+ responseObject.product+" ha sido "+status+". Si desea hablar con un representante de Beachbody, marque 0800-953-6100 para obtener ayuda</div></div>"
...
*/
		document.getElementById("valid_data").innerHTML ="<div class='shipped_order'><div>Su pedido "+responseObject.order_number+" para"+ responseObject.product+" ha sido "+status+". Si desea hablar con un representante de Beachbody, marque (800) 470-7870 para obtener ayuda</div></div>"
          ...
          // track_id="";
			if( (track_id=="" || track_id== null) && (diffDays > 6 ) )//different popup content
			{
				...
				//document.getElementById("valid_data").innerHTML ="<div class='shipped_order'><div>We"+"'"+"ve noticed your order "+responseObject.order_number+" for "+responseObject.product+" placed on "+responseObject.order_create_date+" has not shipped.</div><div> <a href='https://faq.beachbody.com/app/contactus_support/catid/1749/catname/Track-My-Order/ans_sec/8443/TLP/1702.All-Orders-(Other-Nutritionals,-DVDs,-and-Apparel)' target='_blank'>chatear</a> para asistencia.</div>";
				document.getElementById("valid_data").innerHTML ="<div class='shipped_order'><div>Nosotros"+"'"+"he notado su orden "+responseObject.order_number+" para "+responseObject.product+" colocado en "+responseObject.order_create_date+" no ha enviado.</div><div> <a href='https://faq.beachbody.com/app/contactus_support/catid/1749/catname/Track-My-Order/ans_sec/8443/TLP/1702.All-Orders-(Other-Nutritionals,-DVDs,-and-Apparel)' target='_blank'>chatear</a> para asistencia.</div>";
			...
			document.getElementById("valid_data").innerHTML ="<div class='shipped_order'><div>El orden "+responseObject.order_number+" lo pones en "+responseObject.order_create_date+" para "+responseObject.product+" fue recibido y es "+status+".</div><div>¿Que sigue? Recibirá un correo electrónico de confirmación de envío con detalles de seguimiento.</div><div class='new-modi most-order'>Asegúrese de revisar sus carpetas de correo no deseado y correo no deseado si no puede encontrar nuestros correos electrónicos.</div></div>";
			}
			...
			if(isChar(firstTwo )){
				...
				var footer_message="<div class='new-modi-style'>Enviado a través de Hermes</div>";
				}
				else
				{
			...
			var footer_message="<div class='new-modi-style'>Enviado a través de FedEx.com</div>";
			}
			...
			else if(responseObject.tracking_number.length>=12 && responseObject.tracking_number.substring(0,1)=='7')
		   {
			...
			var footer_message="<div class='new-modi-style'>Enviado a través de AfterShip.com</div>";
			}
			}
			...
			document.getElementById("valid_data").innerHTML ="<div class='shipped_order'><div class='order_top'>Su pedido "+responseObject.order_number+" para "+responseObject.product+" colocado en "+responseObject.order_create_date +", muestra que "+status+" en "+responseObject.shipped_date +".</div><div class='track-div'>Su número de seguimiento es</div><div><a href="+href+" target='_blank' >"+responseObject.tracking_number+"</a></div><div class='new-modi'>"+footer_message+"</div></div>";
			}
			else
			{
			
			document.getElementById("valid_data").innerHTML ="<div class='shipped_order'><div>Su pedido reciente está en proceso!!.</div></div>"
	...
	function getOrderStatusMultiple(responseObject) {
		...
		heading += "<div class='multiple_order_links'><span id='links_"+i+"' value='1'><b><a href='javascript:void(0);' onclick='myFunction("+i+","+responseObject.length+");'>"+responseObject[i].product+"</a></b></span><span> ordenado en "+responseObject[i].order_create_date+"</span></div>"; 
	      ...
	      if(responseObject[i].order_status_id == 2 || responseObject[i].order_status_id == 6)
		  {
			...
			*/
			...
			if((track_id=="" || track_id== null) && (diffDays > 6 ))//different popup content
			{
				 ...
				 heading +="<div class='multiple_order' id='block_"+i+"'style='display:none;'><div>Nosotros"+"'"+"he notado su orden "+responseObject[i].order_number+" for "+responseObject[i].product+" colocado en "+responseObject[i].order_create_date+" no ha enviado.</div> <div> <a href='https://faq.beachbody.com/app/contactus_support/catid/1749/catname/Track-My-Order/ans_sec/8443/TLP/1702.All-Orders-(Other-Nutritionals,-DVDs,-and-Apparel)' target='_blank'>chatear</a> para asistencia.</div></div>";
			...
			heading +="<div class='multiple_order' id='block_"+i+"'style='display:none;'><div>El orden "+responseObject[i].order_number+" lo pones en "+responseObject[i].order_create_date+" para "+responseObject[i].product+" fue recibido y es "+status+".</div><div>¿Que sigue? Recibirá un correo electrónico de confirmación de envío con detalles de seguimiento.</div><div class='new-modi most-order'>Asegúrese de revisar sus carpetas de correo no deseado y correo no deseado si no puede encontrar nuestros correos electrónicos.</div></div>";
			...
			var footer_message="<div class='new-modi-style'>Enviado a través de USPS.com</div>";
			}
			...
			{
			 heading +="<div class='multiple_order' id='block_"+i+"'style='display:none;'><div> Su pedido reciente está en proceso!!.</div></div>"
			}
...
RightNow.Ajax.makeRequest('/cc/AjaxCustom/getCheckboxValue', {checked_value:flag , order_no:value}, {
	...
	function onSubmit(order_number)
	{
		...
		if(phone_number == "")
		{
			...
			document.getElementById("invalid_data").innerHTML ="Por favor ingrese un número de teléfono válido";
		...
		RightNow.Ajax.makeRequest('/cc/AjaxCustom/updatePhoneNumber', {phone_no:phone_number , order_no:order_number}, {
                    successHandler: function(response) {
							...
							if(document.getElementById('div_phone'))
							{
                       		...
                       		document.getElementById("valid_data").innerHTML+="<div id='success_message'>Su número de teléfono ha sido guardado !</div>";

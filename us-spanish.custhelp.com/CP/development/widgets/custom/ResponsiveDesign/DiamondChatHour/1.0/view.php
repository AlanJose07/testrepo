...
<div id="rn_<?=$this->instanceID;?>" class="<?= $this->classList ?>">
  ...
  <div id="rn_<?=$this->instanceID;?>_HoursBlock" class="rn_HoursBlock">
    ...
    <div>
      ...
      <?	
	$keyy = NULL;			
	$hours = $this->data['array1'];
	$enabled = $this->data['array2'];
	...
	if(array_key_exists($i,$arr_duplicates))
	{
		...
		{	
			...
			/*-----------------------------------convert to 12 hour---------------------------------------------*/
				...
				echo $this->day_order($start)." - ".$this->day_order($end).":  "."El chat no está disponible<br/>";
		   ...
		   else if($start)
		   {
			...
			$string2=rtrim($string2,', ');
				...
				echo $this->day_order($start).": "."El chat no está disponible<br/>";

				}
		   }
		   else
		   {
		   echo $this->day_order($i).": "."El chat no está disponible<br/>";
		   }

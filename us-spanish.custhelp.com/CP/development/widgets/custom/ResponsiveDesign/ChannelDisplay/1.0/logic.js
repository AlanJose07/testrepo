...
Custom.Widgets.ResponsiveDesign.ChannelDisplay = RightNow.Field.extend({ 
   overrides: {
        constructor: function(){
			...
			RightNow.Event.subscribe("fbHours",this.fbHours,this);//fired from custom/ResponsiveDesign/CustomFacebookHours
 ...
 */						
                    ...
                    successHandler: function(response) {
								...
								{
								window.location = 'https://us-spanish--tst2.custhelp.com/cc/openlogin/oauth/authorize/beachbody?returnurl=smssurvey/'+encodeURIComponent(this.url_parameter);
								}else{
				 ...
				 */						
									...
									successHandler: function(response) {
												...
												if(response['loggedin'] ==  'no')
												{
												window.location = 'https://us-spanish--tst2.custhelp.com/cc/openlogin/oauth/authorize/beachbody?returnurl=callmenow/'+encodeURIComponent(this.url_parameter);
												}
												else{
...

		{
				...
				{/*
						...
						this.selfserviceform_details=this.data.js.self_service_form_link_path.split('->');
								...
								if(this.selfserviceform_details[1]=="Comprobar el estado del pedido" || this.selfserviceform_details[1]=="Actualizar tarjeta de crédito")
								{   
...
*/			
			RightNow.Ajax.makeRequest('/cc/bbresponsivecontroller/loginsession', {text:login_url}, {
                    successHandler: function(response) {
								...
								if(response['loggedin'] ==  'no')
								{ 
								window.location = 'https://us-spanish--tst2.custhelp.com/cc/openlogin/oauth/authorize/beachbody?returnurl=chat/prechatsurvey/'+encodeURIComponent(this.url_parameter);
								}else{
...
*/
						...
						//var displayBlock =["zipcode","email","first-name","last-name","agent-help","language","chat-title","remove-callus-email","hide-for-email-confirm-popup","file-upload","bsf","membertype","lifetimerank"];
...
*/			
			RightNow.Ajax.makeRequest('/cc/bbresponsivecontroller/loginsession_fb/facebook', {text:login_url}, {
                    successHandler: function(response) {
								...
								if(response['loggedin'] ==  'no')
								{ 
									window.location = 'https://us-spanish--tst2.custhelp.com/cc/openlogin/oauth/authorize/beachbody?returnurl=chat/facebooksurvey/'+encodeURIComponent(this.url_parameter);
								}else{
...
*/
				       ...
				       // the first code comment and the second code created..
						...
						else
						{
								...
								{
                                    if(this.top_parent[0]=='3784') {
                                         var displayBlock =["zipcode","email","first-name","last-name","submit-button","hide-for-email-confirm-popup","file-upload","lifetimerank","agent-help","membertype","order-no","bike-serial","tablet-id"];
                                        var displayNone =["coachid","phone-us","regular-chat-hours","spanish-chat-hours","spanish-message-outbound-time","spanish-message-chat-not-available","remove-callus-email","chat-title","phone-title","ask-title","after-submit-email","rn_errorlocation_chat","email-conf-title","language"]; 
                                    }
                                    else{
                                         var displayBlock =["zipcode","email","first-name","last-name","submit-button","hide-for-email-confirm-popup","file-upload","lifetimerank","agent-help","membertype"];
                                        var displayNone =["coachid","phone-us","regular-chat-hours","spanish-chat-hours","spanish-message-outbound-time","spanish-message-chat-not-available","remove-callus-email","chat-title","phone-title","ask-title","after-submit-email","rn_errorlocation_chat","email-conf-title","language","order-no","bike-serial","tablet-id"]; 
                                    }
						...
						//if(typeof(set_fire_subscribe) == 'undefined' || set_fire_subscribe==null || set_fire_subscribe=="")
						//{
						/* commenting for myxbike required issue fix
				...
				else if(checked_channel=='1885')//Document
				{
								...
								if(this.data.js.isloggedin=="loggedin")
						{
						var displayBlock =["coachid","bsf","submit-button","hide-for-email-confirm-popup","file-upload"];
						var displayNone =["phone-us","agent-help","regular-chat-hours","spanish-chat-hours","spanish-message-outbound-time","spanish-message-chat-not-available","remove-callus-email","chat-title","phone-title","ask-title","after-submit-email","rn_errorlocation_chat","email-conf-title","email","first-name","last-name","order-no","bike-serial","tablet-id","zipcode","lifetimerank"];
						}
						else
						{
							var displayBlock =["coachid","bsf","email","first-name","last-name","submit-button","hide-for-email-confirm-popup","file-upload"];
						var displayNone =["phone-us","agent-help","regular-chat-hours","spanish-chat-hours","spanish-message-outbound-time","spanish-message-chat-not-available","remove-callus-email","chat-title","phone-title","ask-title","after-submit-email","rn_errorlocation_chat","email-conf-title","order-no","bike-serial","tablet-id","zipcode","lifetimerank"];
						}
...
*/
				...
				var displayNone =["phone-us","phone-title","email-title","ask-title","facebook-title","after-submit-email","rn_errorlocation_chat","file-upload","email-conf-title"];
				this._displayBlock(displayBlock);
				this._displayNone(displayNone);
...
*/
		...
		else if(checked_channel=='1885')//Document
		{
						...
						{
							var displayBlock =["bsf","email","first-name","last-name","coachid","submit-button","hide-for-email-confirm-popup","file-upload"];
							var displayNone =["phone-us","agent-help","regular-chat-hours","spanish-chat-hours","spanish-message-outbound-time","spanish-message-chat-not-available","remove-callus-email","chat-title","phone-title","ask-title","after-submit-email","rn_errorlocation_chat","email-conf-title","order-no","bike-serial","tablet-id","zipcode","lifetimerank"];
						}
...
/*********************************************end of display_fields_for_all_categories()********************************************************************************/
	...
	{
		if(product_name=="Comprobar el estado del pedido")
		{
			var modal = document.getElementById('myModal');
			modal.style.display = "block";
			
		}
		if(product_name=="Actualizar tarjeta de crédito")
		{

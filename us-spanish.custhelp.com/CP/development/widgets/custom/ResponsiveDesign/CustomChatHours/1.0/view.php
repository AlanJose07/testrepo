...
<div id="rn_<?=$this->instanceID;?>" class="<?= $this->classList ?>">
    ...
    <div id="rn_<?=$this->instanceID;?>_HoursBlock" class="rn_HoursBlock">
        ...
        <? if($this->data['js']['checktime']==1):?>
			<? if($this->data['js']['checkday']!=1):?>
		        <? if($this->data['chatHours']['hours'][$i][0]!='Sáb y Dom'): ?>
            ...
            <div>
				...
				<? if($this->data['js']['checktime']==1):?>
				   <? if($this->data['js']['checkday']==1):?>
						...
						<? elseif($this->data['chatHours']['hours'][$i][0]=='Dom'):?>
						<?= "Dom: " ?> <?=$this->data['chatHours']['hours'][$i][1] ?> 	
						<? else: ?>   
				   ...
				   <? else: ?> 
						  ...
						  <? else: ?> 
								<? if($this->data['chatHours']['hours'][$i][0]=='Sáb y Dom'):?>
								<?= "Sáb y Dom: " ?> <?=$this->data['chatHours']['hours'][$i][1] ?> 
								<? elseif($this->data['chatHours']['hours'][$i][0]=='Dom'):?>
								<?= "Dom: " ?> <?=$this->data['chatHours']['hours'][$i][1] ?> 
								<? else: ?>
								<?=$this->data['chatHours']['hours'][$i][1] ?> <?=$this->data['chatHours']['hours'][$i][0] ?>

  ...
  <br />
	  ...
	  <!--
       ...
       foreach($reasons as $items) 
		...
		<br />
<!--	<label for="Additional Feedback" style="font-weight:bold"> Comentarios adicionales </label>   -->
		<label for="Additional Feedback" style="font-weight:bold"> Gracias por sus comentarios para ayudarnos a mejorar nuestras preguntas frecuentes. </br> Tenga en cuenta que no obtendrá una respuesta. </label>
		<br />
		<textarea rows="4" cols="50" id="add_feedback" name="add_feedback" style="border:solid" placeholder="Opcional"></textarea>
		</div>
		</div>

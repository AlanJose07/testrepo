...
class CategoryTile extends \RightNow\Libraries\Widget\Base {
    ...
    function getData() {
		...
		if($text->count()>0)
	   {
		...
		{
		 $query="select BB.categ_contac_hom_sp from BB.categ_contac_hom_sp where BB.categ_contac_hom_sp.visible_on_page.ID=".$page_id." and BB.categ_contac_hom_sp.enable=1 and BB.categ_contac_hom_sp.interface.ID=".$interface_id." ORDER BY BB.categ_contac_hom_sp.display_order";  
		}
		else                // else condition for the contact us flow
		{
		 
		 $query="select BB.categ_contac_hom_sp from BB.categ_contac_hom_sp where BB.categ_contac_hom_sp.visible_on_page.ID=".$page_id." and BB.categ_contac_hom_sp.category.Parent.ID=".$cat_id." and BB.categ_contac_hom_sp.enable=1 and BB.categ_contac_hom_sp.interface.ID=".$interface_id." ORDER BY BB.categ_contac_hom_sp.display_order";
		}

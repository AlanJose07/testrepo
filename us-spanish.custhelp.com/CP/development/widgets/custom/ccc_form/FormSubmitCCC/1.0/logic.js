RightNow.namespace('Custom.Widgets.ccc_form.FormSubmitCCC');
Custom.Widgets.ccc_form.FormSubmitCCC = RightNow.Widgets.FormSubmit.extend({ 
    /**
	...
	//	alert(2);
		...
		if(document.getElementById("rn_ErrorLocation").innerHTML=="")
		{
			//alert("nui");

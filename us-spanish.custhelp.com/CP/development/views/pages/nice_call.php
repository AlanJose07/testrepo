...
<? }else {?>
<div id="rn_SmsTitle" class="rn_FloatLeft" style="font-size:18px !important;">Tu llamada está siendo conectada.</div>
<div id="rn_SmsDialogTitle" class="" style="padding:12px 10px 100% 10px !important;font-size:16px !important;">
Por favor, contesta la llamada cuando suene tu teléfono.
</div>
</div>
<?php
}?>

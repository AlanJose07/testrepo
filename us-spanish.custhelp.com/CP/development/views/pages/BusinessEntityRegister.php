...
<div id="rn_PageContent" class="">
	...
	<rn:widget path="custom/opa/OPAWidget" policy_model ="Business Entity" web_determinations_url =  "https://beachbodyopa.custhelp.com/web-determinations" init_id = "" locale="es-US"  seed_data=#rn:php:$seedDataJson#/>

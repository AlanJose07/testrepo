    		...
    		<div class="rn_wrap">   
					...
					<strong style="font-weight:bold!important;margin-left:170px!important;"></strong>
						<div style="font-size:15px;">
							<ul>
								<li> Revisaremos tu solicitud y te enviaremos un correo electrónico a más tardar en dos días hábiles.</br> </br> </li>
								<li> Tu número de expediente es <b><?= $referencenumber ?></b> </li>
							</ul>
						</div>
					</div>

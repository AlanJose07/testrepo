...
<div class="answer_detail" id="answercontent">
  <div class="container">
    ...
    <div class="rn_AnswerDetail">
	  ...
	  <rn:widget path="custom/ResponsiveDesign/AnswerFeedback" dialog_threshold="1" label_title="¿Te resultó útil esta respuesta?" label_dialog_description  ="Seleccione lo que mejor describe la información: " submit_feedback_ajax="/cc/AjaxCustom/submitAnswerFeedback" label_dialog_title=""/>
	    <!--<rn:widget path="custom/feedback/AnswerFeedbackReasontest"  label_title="¿Te resultó útil esta respuesta?" dialog_threshold="1" label_dialog_description  ="Seleccione lo que mejor describe la información: " submit_feedback_ajax="/cc/AjaxCustom/submitAnswerFeedback" label_dialog_title=""/>-->
      </div>
    </div>
  </div>
</div>

    ...
    <div id="rn_ChatContainer">
        <div id="rn_PageContent" class="rn_Live">
            <div class="rn_Padding">
					...
					<div id="rn_ChatDialogTitle" class="rn_FloatLeft">Por favor ingrese su pregunta en el espacio debajo.<!--#rn:msg:CHAT_LBL#--></div>
					</rn:condition>
		...
		<div id="popup-message-guest"  style="text-align: center;display: none;">
			<p>	
				Si el chat no se inicia automáticamente, verifica si las ventanas emergentes están permitidas para este sitio web.
			</p>
		</div>
		...
		Si el chat no se inicia automáticamente, verifica si las ventanas emergentes están permitidas para este sitio web.
		 ...
		 <rn:widget path="chat/ChatHours" label_chat_hours ="Chat en Español" />  
		 </div>

...
<?php 
$pagenotfound = utf8_encode("La p�gina que est�s buscando ya no existe.");
$homepage = utf8_encode("nuestra p�gina de inicio de soporte de Beachbody.");
?>
<div class="pos-maker">
	<div id="rn_PageNotFound" class="rn_PageNotFound">
		<div id="title_support_pagenotfound" style="display:block; text-align:center;margin-top: 10px;">
			<h2><?= $pagenotfound; ?></h2>
			Por favor visite <a href='/app/home'><?= $homepage; ?></a>		
		</div>	
	</div>
</div>

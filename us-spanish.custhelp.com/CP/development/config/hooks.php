...
/* start hooks for AAQ Customization for anonymous AAQ */
$rnHooks['pre_contact_create'][] = array(
				   'class' => 'MyContactModel',
				   'function' => 'create',
				   'filepath' => ''
				   );
$rnHooks['pre_contact_update'][] = array(
				   'class' => 'MyContactModel',
				   'function' => 'update',
				   'filepath' => ''
				   );
...
/* end hooks for AAQ Customization for anonymous AAQ */	

/* start hooks for proactive chat */
$rnHooks['pre_page_render'][] = array(
				   'class' => 'AL_Theme_Model',
				   'function' => 'setTheme',
				   'filepath' => ''
				   );	
/* end hooks for proactive chat */

/* start hooks for pre login 
$rnHooks['pre_login'][] = array(
				   'class' => 'MYSAMLLogin',
				   'function' => 'checkContact',
				   'filepath' => ''
				   );	
/* end hooks for pre login */
/* start hooks for post login 
$rnHooks['post_login'][] = array(
				   'class' => 'MYSAMLLogin',
				   'function' => 'redirect',
				   'filepath' => ''
				   );	
/* end hooks for post login */
?>
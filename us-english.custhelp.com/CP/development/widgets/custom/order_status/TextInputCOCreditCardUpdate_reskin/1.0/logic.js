...
RightNow.namespace('Custom.Widgets.order_status.TextInputCOCreditCardUpdate_reskin');
Custom.Widgets.order_status.TextInputCOCreditCardUpdate_reskin = RightNow.Field.extend({
    overrides: {

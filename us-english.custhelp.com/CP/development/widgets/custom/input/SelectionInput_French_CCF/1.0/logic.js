RightNow.namespace('Custom.Widgets.input.SelectionInput_French_CCF');
Custom.Widgets.input.SelectionInput_French_CCF = RightNow.Widgets.SelectionInput.extend({ 
    /**
    ...
    overrides: {
        ...
        constructor: function(data, instanceID) {
			...
			if((fieldName == "Incident.CustomFields.c.ccf_shakeology")||(fieldName == "Incident.CustomFields.c.ccf_tbb_club_membership")||(fieldName == "Incident.CustomFields.c.ccf_other_continued_services") ||(fieldName == "Incident.CustomFields.c.ccf_pro_team") )
			{
				...
				if(fieldName == "Incident.CustomFields.c.ccf_shakeology_boost_french")
			{
			...
			if(fieldName == "Incident.CustomFields.c.ccf_performance_french")
			{
			...
			if(fieldName == "Incident.CustomFields.c.ccf_3_day_refresh_french")
			{
	...
	displayErrorCheckbox: function(errors, errorLocation) {
        ...
        if(commonErrorDiv) {
            for(var i = 0, errorString = "", message, id = "terms_of_cancellation"; i < errors.length; i++) {
				...
				var message = "S'il vous plaît sélectionner au moins un service que vous souhaitez continuer";

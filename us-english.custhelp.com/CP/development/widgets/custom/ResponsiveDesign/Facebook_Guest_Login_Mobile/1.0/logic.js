		...
		list.addEventListener("click", function(e) {
			...
			RightNow.Ajax.makeRequest('/cc/bbresponsivecontroller/loginsession_fb/facebook', {text:login_url}, {
                    successHandler: function(response) {
						...
						{
						window.location = "https://"+this.site_url+"/cc/openlogin/oauth/authorize/beachbody?returnurl==chat/facebooksurvey/"+url_parameter;
						//window.location = 'https://us-english--tst2.custhelp.com/cc/openlogin/oauth/authorize/beachbody?returnurl=chat/facebooksurvey/'+url_parameter;
						}

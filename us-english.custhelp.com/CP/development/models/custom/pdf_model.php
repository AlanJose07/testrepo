	...
	*/
	...
	{		
		...
		*/
		...
		{
			$cancellation = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", "customFields.c.ccf_reason_for_cancellation"); 
		...
		{
			$life_time_rank = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", "customFields.c.life_time_rank"); 
	 ...
	 $y-=30;
		...
		{
			$performance = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", "customFields.c.ccf_performance"); 
		...
		{
			$shakeology_boost = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", "customFields.c.ccf_shakeology_boost"); 
		...
		{
			$refresh = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", "customFields.c.ccf_3_day_refresh"); 
	...
	*/
	...
	{		
		...
		*/
		...
		{
			$cancellation = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", "customFields.c.ccf_reason_for_cancellation_fr"); 
...
//		$new_word=utf8_decode($word);//urldecode($word);
		...
		*/
		...
		{
			$performance = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", "customFields.c.ccf_performance_french"); 
				foreach($performance as $items)
				{
		...
		{
			$shakeology_boost = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", "customFields.c.ccf_shakeology_boost_french"); 
				foreach($shakeology_boost as $items)
				{
		...
		{
			$refresh = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", "customFields.c.ccf_3_day_refresh_french"); 
				foreach($refresh as $items)
				{
	...
	*/
	...
	{		
		...
		*/
		...
		{
			$cancellation = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", "customFields.c.ccf_reason_for_cancellation_sp"); 
...
//		$new_word=utf8_decode($word);//urldecode($word);
	...
	/*	$inc=7;
		...
		*/
		...
		{
			$performance = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", "customFields.c.ccf_performance_spanish"); 
				foreach($performance as $items)
				{
		...
		{
			$shakeology_boost = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", "customFields.c.ccf_shakeology_boost_spanish"); 
				foreach($shakeology_boost as $items)
				{
		...
		{
			$refresh = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", "customFields.c.ccf_3_day_refresh_spanish"); 
				foreach($refresh as $items)
				{

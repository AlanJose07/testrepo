	  ...
	  try
	  {
		  ...
		  if($dataArray["First"] != "" && $dataArray["Last"] != "" ){
		   ...
		   // $updateAccountObj->StateorProvince = "YU";
			...
			$card_type = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Update_Acnt\\credit_card_type");
			...
			$formRoute = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", "customFields.c.form_routing"); 

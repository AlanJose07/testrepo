...
<link href="/euf/assets/themes/responsive/css/style_test1.css" rel="stylesheet">
...
<section class="banner inner-banner">
  ...
  <span class="right-bar"></span>
          ...
          <ul id="nav_ul">
            <li class="nav_li">
			<? if ($home) { ?>
				<a href="#" class="nav_link" id="gethelplink" onClick="click_tracking('BROWSE FAQs BY TOPIC')">BROWSE FAQs BY TOPIC</a>
			<? } else {  ?>
				<a href="/app/home/gethelp/1" class="nav_link"  onClick="click_tracking('BROWSE FAQs BY TOPIC')">BROWSE FAQs BY TOPIC</a>
			<? } ?>
			</li>
           ...
           <div class="c-dropdown js-dropdown">
                ...
                <ul class="c-dropdown__list">
				  ...
				  <li  onclick="location.href='https://faq.fr.beachbody.ca/app/home';" class="c-dropdown__item" data-dropdown-value="UK" imageName ="/euf/assets/themes/responsive/images/ca.png"><img src="/euf/assets/themes/responsive/images/ca.png">CANADA (FRANÇAIS)</li>
...
function click_tracking(text,catid = 0,ans_views = 0) {
	...
	//alert("clicked --"+text+"---"+catid+"---"+ans_views+"---"+page_url);
	//clicked --Category Tiles - Technical-Support---2069---0---https://faq.beachbody.com/app/home
	//alert(page_url);
	var mobile = 1;

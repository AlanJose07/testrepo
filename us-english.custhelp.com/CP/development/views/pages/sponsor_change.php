...
//	echo "member_typ_aftr = ".$customertype ;
	...
	if($currentidcoachdate || $currentidpcdate){
		...
		//echo "\n current_id_coach_date ".$current_id_coach_date;
		$date_limit_currentidcoachdate = date('Y-m-d', strtotime($current_id_coach_date. ' + 10 days'));
		//echo "\n date_limit_currentidcoachdate ".$date_limit_currentidcoachdate;
		$date_limit_timestamp_currentidcoachdate = strtotime($date_limit_currentidcoachdate);
		//echo "\n date_limit_timestamp_currentidcoachdate ".$date_limit_timestamp_currentidcoachdate;
...
<rn:widget path="input/SelectionInput" name="Incident.CustomFields.c.form_routing" required="false" default_value="1748"/>

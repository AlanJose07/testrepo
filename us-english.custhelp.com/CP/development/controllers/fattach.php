...
{ 
	...
	try {
		...
		if($results){
			header('Location:/app/coach_cancellation_form_confirm?refno='.$results);
		exit;
		}
	}
	catch (Exception $err )
    ...
    {   
		...
		if($results){
		header('Location:/app/coach_cancellation_form_french_confirm?refno='.$results);
		}
    ...
    {   
		...
		if($results){
		header('Location:/app/coach_cancellation_form_spanish_confirm?refno='.$results);
		}

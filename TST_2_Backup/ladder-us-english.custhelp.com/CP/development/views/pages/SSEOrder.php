<rn:meta title="Beachbody"  clickstream="opa" force_https="false" /><head>
...
<div id="rn_PageContent" class="">
				 ...
				 {		
					if( empty($_GET['pagecount']))
					{
						...
						if ($safari and empty($_GET['screen']))
							{
								$loc = "https://faq.beachbody.com/app/SSEOrder?". http_build_query($_GET) ."&screen=new";
					...
					//logmessage($url);
						 ...
						 $loc = "https://faq.beachbody.com/app/SSEOrder?". str_replace('$','&',substr($_GET['pagecount'],2));
	...
	<rn:widget path="custom/opa/OPAWidget" policy_model ="Beachbody_OrderManagement_1XHD" web_determinations_url = "https://beachbodyopa.custhelp.com/web-determinations" init_id = "" locale="en-US"  seed_data=#rn:php:$seedDataJson#/>
	<?php elseif(json_decode($seedDataJson)->loc == "es_US") : ?>
	<rn:widget path="custom/opa/OPAWidget" policy_model ="Beachbody_OrderManagement_1XHD" web_determinations_url = "https://beachbodyopa.custhelp.com/web-determinations" init_id = "" locale="es-US"  seed_data=#rn:php:$seedDataJson#/>
	<?php elseif(json_decode($seedDataJson)->loc == "fr_CA") : ?>
	<rn:widget path="custom/opa/OPAWidget" policy_model ="Beachbody_OrderManagement_1XHD" web_determinations_url = "https://beachbodyopa.custhelp.com/web-determinations" init_id = "" locale="fr-CA"  seed_data=#rn:php:$seedDataJson#/>

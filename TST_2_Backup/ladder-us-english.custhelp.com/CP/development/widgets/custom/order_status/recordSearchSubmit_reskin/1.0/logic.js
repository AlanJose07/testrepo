RightNow.namespace('Custom.Widgets.order_status.recordSearchSubmit_reskin');
Custom.Widgets.order_status.recordSearchSubmit_reskin = RightNow.Widgets.FormSubmit.extend({
    /**

...
RightNow.namespace('Custom.Widgets.order_status.TextInputCOMobile');
Custom.Widgets.order_status.TextInputCOMobile = RightNow.Field.extend({
    overrides: {
    ...
    _displayError: function(errors, errorLocation,email_zip_err_flag) {
        ...
        if(commonErrorDiv) {
			...
			else if(email_zip_err_flag == 3)
			{
				...
				document.getElementsByName("CO.order_tracking_new.zip_code")[1].className='rn_Text rn_ErrorField';
			}

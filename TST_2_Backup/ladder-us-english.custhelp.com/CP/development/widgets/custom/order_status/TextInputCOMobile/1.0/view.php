...
<? if ($this->data['attrs']['label_input']): ?>
	...
	<?php }else{?>
    <input type="text" id="rn_<?=$this->instanceID;?>_<?=$this->data['attrs']['name'];?>" name="<?=$this->data['attrs']['name'];?>" class="rn_Text" <?=tabIndex($this->data['attrs']['tabindex'], 1);?> <? if($this->data['attrs']['max_length']): echo('maxlength="' . $this->data['attrs']['max_length'] . '"'); endif;?> value="<?=$this->data['value'];?>"/>
	<?php }?>	
<? endif; ?>

 ...
 */						
                    ...
                    successHandler: function(response) {
								...
								{
								window.location = 'https://faq.beachbody.com/cc/openlogin/oauth/authorize/beachbody?returnurl=smssurvey/'+this.url_parameter;
								}else{
...

		{
				...
				{/*
						...
						this.selfserviceform_details=this.data.js.self_service_form_link_path;
						
								if(this.selfserviceform_details=="Check Order Status" || this.selfserviceform_details=="Update Credit Card")
								{
								
										this.showPopup(this.selfserviceform_details);
								}
								else
								{
...
*/			
			RightNow.Ajax.makeRequest('/cc/bbresponsivecontroller/loginsession', {text:login_url}, {
                    successHandler: function(response) {
								...
								if(response['loggedin'] ==  'no')
								{ 
								window.location = 'https://faq.beachbody.com/cc/openlogin/oauth/authorize/beachbody?returnurl=chat/prechatsurvey/'+this.url_parameter;
								}else{
...
*/			
			RightNow.Ajax.makeRequest('/cc/bbresponsivecontroller/loginsession_fb/facebook', {text:login_url}, {
                    successHandler: function(response) {
								...
								if(response['loggedin'] ==  'no')
								{ 
									window.location = 'https://faq.beachbody.com/cc/openlogin/oauth/authorize/beachbody?returnurl=chat/facebooksurvey/'+this.url_parameter;
								}else{
...
*/
				       ...
				       // the first code comment and the second code created..
						...
						var displayNone =["coachid","agent-help","phone-us","regular-chat-hours","spanish-chat-hours","spanish-message-outbound-time","spanish-message-chat-not-available","remove-callus-email","chat-title","phone-title","ask-title","after-submit-email","rn_errorlocation_chat","email-conf-title","email","first-name","last-name"];
							}
							else
							{
						...
						var displayNone =["coachid","agent-help","phone-us","regular-chat-hours","spanish-chat-hours","spanish-message-outbound-time","spanish-message-chat-not-available","remove-callus-email","chat-title","phone-title","ask-title","after-submit-email","rn_errorlocation_chat","email-conf-title"];
							}
		...
		{/*
				if(typeof(this.data.js.self_service_form_link_path) !== 'undefined' && this.data.js.self_service_form_link_path!==null && this.data.js.self_service_form_link_path!=="")
						...
						this.selfserviceform_details=this.data.js.self_service_form_link_path;
								...
								{
										window.open(this.selfserviceform_details);
								}
						}
...
*/
				...
				else
				{
						...
						if(this.data.js.isloggedin=="loggedin")
						{ 
							var displayBlock =["bsf","lifetimerank","language","coachid","submit-button","hide-for-email-confirm-popup","file-upload"];
				var displayNone =["phone-us","agent-help","regular-chat-hours","spanish-chat-hours","spanish-message-outbound-time","spanish-message-chat-not-available","remove-callus-email","chat-title","phone-title","ask-title","after-submit-email","rn_errorlocation_chat","email-conf-title","email","first-name","last-name"];
						}
						else
						{ 
							var displayBlock =["bsf","email","first-name","last-name","lifetimerank","language","coachid","submit-button","hide-for-email-confirm-popup","file-upload"];
				var displayNone =["phone-us","agent-help","regular-chat-hours","spanish-chat-hours","spanish-message-outbound-time","spanish-message-chat-not-available","remove-callus-email","chat-title","phone-title","ask-title","after-submit-email","rn_errorlocation_chat","email-conf-title"];
						}

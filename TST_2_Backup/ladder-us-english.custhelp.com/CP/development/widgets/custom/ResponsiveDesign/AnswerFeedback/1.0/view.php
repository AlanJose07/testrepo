  ...
  <br />
	  ...
	  <!--
       ...
       foreach($reasons as $items) 
		...
		<br />
<!--	<label for="Additional Feedback" style="font-weight:bold"> Additional Feedback </label>   -->
		<label for="Additional Feedback" style="font-weight:bold"> Thank you for your feedback to help us improve our FAQs. </br> Please note that you will not get a response. </label>
		<br />
		<textarea rows="4" cols="50" id="add_feedback" name="add_feedback" style="border:solid" placeholder="Optional"></textarea>
		</div>
		</div>

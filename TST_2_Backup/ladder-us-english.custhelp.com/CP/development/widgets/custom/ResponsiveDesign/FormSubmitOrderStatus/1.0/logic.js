       ...
       RightNow.Event.subscribe("on_before_ajax_request", this._onBeforeAjaxRequest, this);
        ...
        if (!responseObject) { 
			...
			if(country_id==2)//canada
			{
				...
				document.getElementById("errors").innerHTML +=	"<div><b><a href='https://faq.beachbody.ca/app/contactus_support/catid/1749/catname/Track-My-Order/ans_sec/8443/TLP/1702.All-Orders-(Other-Nutritionals,-DVDs,-and-Apparel)' target='_blank' >Chat</a> <span>for assistance</span></b></div>";

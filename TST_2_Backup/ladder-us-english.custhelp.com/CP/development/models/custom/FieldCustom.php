 ...
 */
class FieldCustom extends \RightNow\Models\Base {
            ...
            //Incident create email only (and can optionally contain other contact fields)
                ...
                if($existingContact){
                    ...
                    $formData['Incident.PrimaryContact'] = $existingContact;
					 $con = RNCPHP\Contact::fetch($existingContact);
					 if($con->Phones[0]->Number === null)
					 {
					  
					   $con->Phones[0]->Number = $formData['Contact.Phones.HOME.Number']->value;
					   $con->save();

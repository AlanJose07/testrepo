...
<form id="rn_ChatLaunchForm" method="post" action="">
	...
	<rn:widget path="custom/ResponsiveDesign/Language" name="Incident.c$language_shk" label_input="Preferred Response Language" default_value="1182" interface=3 required="true"/>
		</div>
...
<rn:widget path="custom/ResponsiveDesign/PhoneHourDetails" interface=3/>
</div>
...
<div id="myModal" class="modal View_Modal pop-modal">
  ...
  <form id="rn_QuestionSubmit" method="post">
        ...
        <div class="form-dv">
       		     ...
       		     <div class="left-box">
                     <rn:widget path="custom/ResponsiveDesign/countrySelectionInput_OrderStatus" name="Contact.Address.Country" required="false" label_input = "Country/Pais/Pays" default_value='7' allow_external_login_updates="true"/>
                </div>
   ...
   <!-- <span class="close" onClick="closePopUp()"  style="display: none">X</span>-->
	...
	<div id="formdisplay" style="display: none">
		...
		<form id="form" onsubmit="return false">
				...
				<div class="country">
				<rn:widget path="custom/ResponsiveDesign/countrySelectionInput_ccu" name="Contact.Address.Country" required="true" label_input = "Country" default_value='7' allow_external_login_updates="true"/>
				</div>

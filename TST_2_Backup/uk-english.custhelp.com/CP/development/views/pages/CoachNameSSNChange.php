...
<div id="rn_PageContent" class="">
	...
	<rn:widget path="custom/opa/OPAWidget" policy_model ="Name-SSN-Change" web_determinations_url =  "https://beachbodyopa.custhelp.com/web-determinations" init_id = "" locale="en-GB"  seed_data=#rn:php:$seedDataJson#/>

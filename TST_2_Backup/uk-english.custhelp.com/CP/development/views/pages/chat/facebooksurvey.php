...
#membertype{
    ...
    <div id="rn_ChatContainer">
	    ...
	    <rn:widget path="custom/ResponsiveDesign/Language" name="Incident.c$language_shk" label_input="Preferred Response Language" 
		 default_value="1182" interface=3 required="true"/>
		</div>
		...
		<div class = "fb-message">
		 	<p id = "fb-first-message">Click Next to submit your question on Facebook Messenger.</p>
		</div>
							
		<div id="submit-button" style="display:block">
		<rn:widget path="custom/ResponsiveDesign/Submit" label_button="Next" label_submitting_message = "Next" error_location="rn_errorlocation_chat" on_success_url='none'/>	
		</div>
		...
		<!-- <div id="rn_ChatDialogTitle" class="rn_FloatLeft"><?php echo "Hi ".$this->session->getProfile()->first_name->value.", how can we help you 	 
		 today?" ?></div> -->
		 <div id="rn_ChatDialogTitle" class="rn_FloatLeft">Click Next to submit your question on Facebook Messenger.</div>
	 	 <script>

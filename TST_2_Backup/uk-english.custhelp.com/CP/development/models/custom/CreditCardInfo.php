	  ...
	  try
	  {
		  ...
		  if($dataArray["First"] != "" && $dataArray["Last"] != "" ){
		   ...
		   // $updateAccountObj->StateorProvince = "YU";
		    ...
		    $updateAccountObj->Country = $countries->LookupName;
			//RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_2\\Update_Acnt", "Update_Account_Info.credit_card_type"); 
			...
			//print_r($contact[0]->Address->Country->Name);
			//print_r($contact[0]->Address->Country->ID);
			//$contact[0]->Address->Country = RNCPHP\Country::fetch($dataArray["Country"]);

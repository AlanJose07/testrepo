...
class FacebookChatHours extends \RightNow\Widgets\ChatHours {
    ...
    function getData() {
         ...
         parent::getData();
		 $nowtimezone = trim($hoursData['time_zone'] = strftime('%Z'));  // whether it is gmt or bst
		...
		/* if($nowtimezone=="BST")
			{
				$hours	= Array(
						'1' => '16:00-24:00',
						'2' => '00:00-01:00,16:00-24:00',
						'3' => '00:00-01:00,16:00-24:00',
						'4' => '00:00-01:00,16:00-24:00',
						'5' => '00:00-01:00,16:00-24:00',
						'6' => '00:00-01:00' 
					);
			}

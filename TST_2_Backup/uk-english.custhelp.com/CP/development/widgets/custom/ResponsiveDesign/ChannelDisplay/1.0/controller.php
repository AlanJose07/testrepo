   ...
   function __construct($attrs) {
    ...
    function getData() {
		...
		if (!empty($cat_id))
		{
		 ...
		 $query="select BB.categ_contac_hom_uk from BB.categ_contac_hom_uk where BB.categ_contac_hom_uk.category.ID=".$cat_id." and BB.categ_contac_hom_uk.interface.ID=3 and BB.categ_contac_hom_uk.visible_on_page.ID in(3,4) and BB.categ_contac_hom_uk.enable=1";  
		}

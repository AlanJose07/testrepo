...
<? if($key=="1527"):?>  <!-- ask an expert -->
 ...
 <? $label_image=explode("->",$display_label_image['1532']);?>
			 ...
			 <li class="chat-desktop">
				...
				<div id="recommended-continue-as-guest">
				<a href= "javascript:void(0);" class= "continue_fb disable-click-fb">Continue as guest</a>
				</div>
			...
			<!--	</div> -->
				...
				<? $login_mobile_url_redirect = "/app/contactus_support_fb/".$text; ?>
				<li class="chat-mobile">
				<a href="<?= $login_mobile_url_redirect ?>" class="facebook active-chat disable-click-fb" id="<?= $id?>" onclick="click_tracking('Contact Us - Facebook')">
				<div id="recommended-title-div">Recommended</div>
		...
		<? if($key=="1532"):?>  <!--facebook-->
			...
			//https://ohsqa3.beachbody.com/oamfed/idp/initiatesso?providerid=OCS-QA3 ?>
				...
				<li class="chat-desktop">
					...
					<div class="continue-as-guest-desktop disable-click-fb">
					<a href= "javascript:void(0);" class= "continue_fb">Continue as guest</a>
					</div>
				...
				<!-- </div> -->
				   <? $login_mobile_url_redirect = "/app/contactus_support_fb/".$text; ?>
				    <li class="chat-mobile">
					<a href="<?= $login_mobile_url_redirect ?>" class="facebook disable-click-fb" id="<?= $id?>" onclick="click_tracking('Contact Us - Facebook')">     

...
Custom.Widgets.ResponsiveDesign.ChannelDisplay = RightNow.Field.extend({ 
   overrides: {
        constructor: function(){
			...
			RightNow.Event.subscribe("fbHours",this.fbHours,this);//fired from custom/ResponsiveDesign/FacebookChatHours 
...
/*****************************************************************************************************************************************************************************/	
    ...
    { 
        ...
        if((this.top_parent[0]!=='1704') && (this.top_parent[0]!=='1706'))// if condition-- Not My coach business(not the special categories) 

		{
				...
				if(checked_channel=='1527') //ask an expert                    
				{
						...
						var displayNone =["email","first-name","last-name","agent-help","coachid","bsf","lifetimerank","zipcode","language","regular-chat-hours","submit-button","remove-callus-email","chat-title","email-title","facebook-title","phone-us","phone-title","after-submit-email","hide-for-email-confirm-popup","file-upload","email-conf-title","rn_ErrorLocation_directly","membertype"];
...
*/			
			RightNow.Ajax.makeRequest('/cc/bbresponsivecontroller/loginsession', {text:login_url}, {
                    successHandler: function(response) {
								...
								{ 
								window.location = 'https://uk-english--tst2.custhelp.com/cc/openlogin/oauth/authorize/beachbody?returnurl=chat/prechatsurvey/'+encodeURIComponent(this.url_parameter);
								}else{
...
*/
						...
						var displayBlock =["zipcode","email","first-name","last-name","agent-help","chat-title","remove-callus-email","hide-for-email-confirm-popup","bsf","membertype","lifetimerank"];
						var displayNone =["coachid","phone-us", "phone-title","email-title","ask-title","facebook-title","after-submit-email","rn_errorlocation_chat","email-conf-title","file-upload"];
						this._displayBlock(displayBlock);
						this._displayNone(displayNone);
						
						//if(typeof(set_fire_subscribe) == 'undefined' || set_fire_subscribe==null || set_fire_subscribe=="")
						//{//commented this for the UK
...
*/			
			RightNow.Ajax.makeRequest('/cc/bbresponsivecontroller/loginsession_fb/facebook', {text:login_url}, {
                    successHandler: function(response) {
								...
								if(response['loggedin'] ==  'no')
								{ 
									window.location = 'https://uk-english--tst2.custhelp.com/cc/openlogin/oauth/authorize/beachbody?returnurl=chat/facebooksurvey/'+encodeURIComponent(this.url_parameter);
								}else{
...
*/
								...
								var displayBlock =["zipcode","email","first-name","last-name","agent-help","hide-for-email-confirm-popup","bsf","membertype","lifetimerank","facebook-title"];/**/
								var displayNone =["coachid","phone-us", "phone-title","email-title","ask-title","after-submit-email","rn_errorlocation_chat","file-upload","email-conf-title","chat-title","remove-callus-email","language"];
								this._displayBlock(displayBlock);
								this._displayNone(displayNone);
						...
						else
						{
								...
								{
									var displayBlock =["zipcode","email","first-name","last-name","language","submit-button","hide-for-email-confirm-popup","file-upload",,"agent-help","membertype"];
                                    var displayNone =["coachid","phone-us","regular-chat-hours","spanish-chat-hours","spanish-message-outbound-time","spanish-message-chat-not-available","remove-callus-email","chat-title","phone-title","ask-title","after-submit-email","rn_errorlocation_chat","email-conf-title","language","lifetimerank"]; 
								}
			    ...
			    else if(checked_channel=='1885')//Document 
		        {
						...
						this.showForm();
								...
								if(this.data.js.isloggedin=="loggedin")
						{
					     var displayBlock =["coachid","bsf","language","submit-button","hide-for-email-confirm-popup","file-upload","lifetimerank"];
						var displayNone =["zipcode","agent-help","phone-us","regular-chat-hours","spanish-chat-hours","spanish-message-outbound-time","spanish-message-chat-not-available","remove-callus-email","chat-title","phone-title","ask-title","after-submit-email","rn_errorlocation_chat","email-conf-title","email","first-name","last-name","language"];
							}
						else
						{
							var displayBlock =["coachid","bsf","email","first-name","last-name","language","submit-button","hide-for-email-confirm-popup","file-upload","lifetimerank"];
						var displayNone =["zipcode","agent-help","phone-us","regular-chat-hours","spanish-chat-hours","spanish-message-outbound-time","spanish-message-chat-not-available","remove-callus-email","chat-title","phone-title","ask-title","after-submit-email","rn_errorlocation_chat","email-conf-title","language"];
						}
				...
				else if(checked_channel=='1531')//call us
				{
						...
						var displayNone =["email","first-name","last-name","agent-help","coachid","bsf","lifetimerank","zipcode","language","regular-chat-hours","submit-button","remove-callus-email","chat-title","email-title","ask-title","facebook-title","after-submit-email","rn_errorlocation_chat","file-upload","email-conf-title","membertype"];
						//if(typeof(set_fire_subscribe) == 'undefined' || set_fire_subscribe==null || set_fire_subscribe=="")
						//{
...
*/
				...
				var displayBlock =["bsf","lifetimerank","email","first-name","last-name","agent-help","coachid","remove-callus-email","chat-title","hide-for-email-confirm-popup","zipcode","membertype"];
...
*/
				...
				else
				{
						...
						if(this.data.js.isloggedin=="loggedin")
						{
							var displayBlock =["bsf","lifetimerank","coachid","submit-button","hide-for-email-confirm-popup","file-upload"];
						var displayNone =["phone-us","agent-help","regular-chat-hours","remove-callus-email","chat-title","phone-title","ask-title","after-submit-email","rn_errorlocation_chat","email-conf-title","email","first-name","last-name"];
						}
						else
						{
							var displayBlock =["bsf","lifetimerank","email","first-name","last-name","coachid","submit-button","hide-for-email-confirm-popup","file-upload"];
						var displayNone =["phone-us","agent-help","regular-chat-hours","remove-callus-email","chat-title","phone-title","ask-title","after-submit-email","rn_errorlocation_chat","email-conf-title"];
						}
...
*/
						...
						else
						{
								...
								if(this.data.js.isloggedin=="loggedin")
								{
									var displayBlock =["zipcode","submit-button","hide-for-email-confirm-popup","file-upload","lifetimerank"];
						
								var displayNone =["coachid","agent-help","phone-us","regular-chat-hours","remove-callus-email","chat-title","phone-title","ask-title","after-submit-email","rn_errorlocation_chat","email-conf-title","bblive-chat-status","bblive-chat-hours","email","first-name","last-name"];
								}
								else
								{
									var displayBlock =["zipcode","email","first-name","last-name","submit-button","hide-for-email-confirm-popup","file-upload","lifetimerank"];
						
								var displayNone =["coachid","agent-help","phone-us","regular-chat-hours","remove-callus-email","chat-title","phone-title","ask-title","after-submit-email","rn_errorlocation_chat","email-conf-title","bblive-chat-status","bblive-chat-hours"];
								}

    ...
    methodName: function() {
	 ...
	 _getfieldvalues: function()                                                                                  
	 {
		 ...
		 if(this.data.js.name =="Contact.Emails.PRIMARY.Address")
		{
			...
			var email = document.getElementById("rn_" + prevent_anonymous_email + '_'+this.data.js.name).value; // added to fix anonymous chat when
																												// sso enabled
			
			
			this.input.set('value',email);
		 ...
		 if(this.data.js.name =="Contact.Name.First")
		{
			...
			var first = document.getElementById("rn_" + prevent_anonymous_first + '_'+this.data.js.name).value; // added to fix anonymous chat when
																												// sso enabled
		 ...
		 if(this.data.js.name =="Contact.Name.Last")
		{
			...
			var last = document.getElementById("rn_" + prevent_anonymous_last + '_'+this.data.js.name).value;  // added to fix anonymous chat when
																												// sso enabled

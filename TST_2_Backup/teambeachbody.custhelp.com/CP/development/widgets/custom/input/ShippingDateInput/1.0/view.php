...
<? for ($i = 0; $i < 3; $i++): ?>
    ...
    <select id="rn_<?= $this->instanceID ?>_<?= $this->data['js']['name'] ?>_Year" name="rnDtYear">
    ...
    <select id="rn_<?= $this->instanceID ?>_<?= $this->data['js']['name'] ?>_Month" name="rnDtMonth">
    ...
    <select id="rn_<?= $this->instanceID ?>_<?= $this->data['js']['name'] ?>_Day" name="rnDtDay">

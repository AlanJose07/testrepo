RightNow.namespace('Custom.Widgets.input.SelectionInputAAQ');
Custom.Widgets.input.SelectionInputAAQ = RightNow.Widgets.SelectionInput.extend({ 
    /**
    ...
    overrides: 
	{
         ...
         */
			...
			else if(FieldName === "Incident.CustomFields.c.current_flavor")	
			{
				 ...
				 //this._inputField = document.getElementById("rn_SelectionInputAAQ_10_Incident.CustomFields.c.current_flavor");

...
<td width="42%">
                <div id="rn_<?=$this->instanceID;?>_EditDisclaimer" class="rn_Hidden">
                    Please be advised that a Home Direct Order Modification may impact your active status, 
                    rank and qualifications for contests and promotions such as Success Club.
                </div>
</td>
</tr>
</table>

...
RightNow.namespace('Custom.Widgets.input.ShippingDateSelectionInput');
Custom.Widgets.input.ShippingDateSelectionInput = RightNow.Field.extend({
    overrides: {
        constructor: function(){
			...
			if(fieldName === "shippingdate")
			{
			 ...
			 this._editDisclaimerDiv = "rn_" + this.instanceID + "_EditDisclaimer";
	...
	_onChange: function (type, args) 
	{
		...
		{         // Change Shipping Date
            ...
            this.Y.one('#'+ this._editDisclaimerDiv).removeClass('rn_Hidden').removeClass('rn_EditSelectionHidden');
		...
		else 
		{
            ...
            this.Y.one('#'+ this._editDisclaimerDiv).addClass('rn_Hidden').addClass('rn_EditSelectionHidden');

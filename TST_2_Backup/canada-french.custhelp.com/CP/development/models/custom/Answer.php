...
{ 
	...
	{ 
		...
		$answers = RNCPHP\ROQL::query("SELECT channel.answer FROM CO.channel_decision_ca channel WHERE channel.member_type=".$mem_id." AND channel.request_type=".$req_id.";")->next();
		$ans = $answers->next();
		$result=array(); 

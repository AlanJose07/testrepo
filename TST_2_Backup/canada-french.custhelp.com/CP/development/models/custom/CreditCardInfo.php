	...
	function CreditCardUpdate($data) {
	  ...
	  try
	  {
		...
		*/
		...
		$msg["msg"] ="<b>Votre demande de mise à jour de carte de crédit a été soumise pour traitement. Veuillez prévoir un délai de 24 heures pour que les modifications soient appliquées à votre compte. Le numéro de référence de cette demande est :<span>#".$incidentObj->ReferenceNumber."</b></span>";

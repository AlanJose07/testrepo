    ...
    <div id="rn_ChatContainer">
        <div id="rn_PageContent" class="rn_Live">
            <div class="rn_Padding">
					...
					<div id="rn_ChatDialogTitle" class="rn_FloatLeft">Veuillez écrire votre question ci-dessous.<!--#rn:msg:CHAT_LBL#--></div>
					</rn:condition>
		...
		<div id="popup-message-guest"  style="text-align: center;display: none;">
			<p>	
			Si le clavardage ne démarre pas automatiquement, veuillez vous assurer que les fenêtres contextuelles sont autorisées pour ce site Web.
			</p>
		</div>
		...
		<div id="popup-message-loggedin"  style="text-align: center;display: none;">
		 ...
		 <rn:widget path="chat/ChatHours" label_chat_hours ="Soutien à la clientèle" />  
		 </div>

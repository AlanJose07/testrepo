    ...
    <div id="rn_ChatContainer">
        <div id="rn_PageContent" class="rn_Live">
            <div class="rn_Padding">
					...
					<!-- <div id="rn_ChatDialogTitle" class="rn_FloatLeft">Veuillez écrire votre question ci-dessous.</div> -->
					...
					<div id="rn_ChatDialogTitle" class="rn_FloatLeft">Veuillez vous connecter pour continuer avec Facebook Messenger.<!--#rn:msg:CHAT_LBL#--></div>
					</rn:condition>
	    ...
	    <rn:widget path="custom/ResponsiveDesign/Language" name="Incident.c$language_shk" label_input="Preferred Response Language" 
		 default_value="1183" interface=30 required="true" label_required="Obligatoire"/>
		</div>
		...
		<rn:widget path="custom/ResponsiveDesign/Submit" label_button="CONFIRMER" error_location="rn_errorlocation_chat" on_success_url='none'/>	
		</div>
		
		<div class = "fb-message">
		 	<p id = "fb-first-message">Sans connexion à Messenger votre message ne sera ni reçu, ni traité.</p>
			<p id = "fb-second-message">Veuillez attendre l’ouverture de la page et vous connecter à Facebook.</p>
		</div>
		...
		?>
			...
			<div id="rn_ChatDialogTitle" class="rn_FloatLeft">Malheureusement, Facebook Messenger n’est pas offert pour votre marché. Pour connaître les options d’assistance disponibles, veuillez vous rendre sur la <a style="text-decoration: underline;" href="https://france-french--tst2.custhelp.com/app/contactus">page d’assistance</a> qui vous est désignée.</div>
			<? else: ?>
			<div id="rn_ChatDialogTitle" class="rn_FloatLeft">Malheureusement, Facebook Messenger n’est pas offert pour votre marché. Pour connaître les options d’assistance disponibles, veuillez vous rendre sur la <a style="text-decoration: underline;" href="https://uk-english--tst2.custhelp.com/app/contactus">page d’assistance</a> qui vous est désignée.</div>
			<? endif; ?>
		...
		<rn:widget path="custom/ResponsiveDesign/MemberType" name="Incident.c$member_type_new" label_input="Type de membre" required="true"         default_value="#rn:php:$membertypeid#"/>
		</div>
		...
		<div id="language" class="life_time_rank" style="display:none">
	    <rn:widget path="custom/ResponsiveDesign/Language" name="Incident.c$language_shk" label_input="Preferred Response Language" 
		 default_value="1183" interface=30 required="true"/>
		</div>

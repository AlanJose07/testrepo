        ...
        <div id="rn_PageContent" class="rn_Live">
            <div class="rn_Padding">
                    ...
                    <div id="rn_ChatDialogHeaderContainer">
					 ...
					 <?
if($CI->session->getSessionData('iscallmenowavailable')=='false'){
...
<div class="pagecontainer-screen-chat">
    ...
    width: 30px;">
     ...
     <!--   <div class="chatwindowcontainre rn_hidden">
            <iframe src="https://home-c35.nice-incontact.com/inContact/ChatClient/ChatClient.aspx?poc=<php echo $nice_chat_poc;?>&bu=4599337&p1=<php echo $incidentid;?>&p2=<php echo $chatskill;?>&p3=<php echo $phnumber;?>&p4=<php echo $coachdate;?>" id="iframe_id" class="iframeclass"></iframe> 
        </div>-->
...
<? }else {?>
<div id="rn_SmsTitle" class="rn_FloatLeft" style="font-size:18px !important;">Votre appel est en cours de connexion.</div>
<div id="rn_SmsDialogTitle" class="" style="padding:12px 10px 100% 10px !important;font-size:16px !important;">
Veuillez répondre au téléphone lorsqu’il sonnera.
</div>
</div>
<?php
}?>

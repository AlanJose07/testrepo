  ...
  <div class="container">
    ...
    <div class="rn_AnswerDetail">
	  ...
	  <!-- <rn:widget path="custom/ResponsiveDesign/AnswerFeedbackReason" dialog_threshold="1" label_dialog_description  ="Please select what best describes the information: " submit_feedback_ajax="/cc/AjaxCustom/submitAnswerFeedback" label_dialog_title=""/>-->
	    <rn:widget path="custom/ResponsiveDesign/AnswerFeedback" dialog_threshold="1" label_dialog_description  ="Veuillez sélectionner ce qui décrit le mieux l'information:" submit_feedback_ajax="/cc/AjaxCustom/submitAnswerFeedback" label_dialog_title=""/>
      </div>
    </div>
  </div>
</div>

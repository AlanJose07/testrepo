...
<form id="rn_ChatLaunchForm" method="post" action="">
		...
		<div class="overlay-form" id="self-service">
		 ...
		 <h1 id="chat-title" style="display:none">Clavarder</h1>  
		 <h1 id="phone-title" style="display:none">Appeler le support</h1>
		 <h1 id="email-title" style="display:none">Envoyez-nous un email </h1>
		  <h1 id="doc-title" style="display:none">Soumettre un Document </h1>
		 <h1 id="email-conf-title" style="display:none">confirmation de l'émail</h1>
		 <h1 id="facebook-title" style="display:none">Facebook Messenger</h1>
		 <h1 id="call-me-now-title" style="display:none">Appelez-moi</h1>
		...
		<rn:widget path="custom/ResponsiveDesign/MemberType" name="Incident.c$member_type_new" label_input="Type de membre" required="true" label_required="Obligatoire" />
		</div>
		
		<div id="coachid" style="display:none">
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Incident.c$coachcustomernumber" label_input="ID Coach" required="true" label_required="Obligatoire" />
		</div>  
		
		<div id="bsf" style="display:none">
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Incident.c$last_four_ssn" label_input="4 derniers # de la carte de crédit" required="true" label_required="Obligatoire" />
		</div>
		
		<div id="lifetimerank" class="life_time_rank" style="display:none">
		<rn:widget path="custom/ResponsiveDesign/SelectionInput" name="Incident.c$life_time_rank" label_input="Rang à Vie" required="true" label_required="Obligatoire" />
		</div>
		
		<div id="zipcode" style="display:none">
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Incident.c$billing_zip_postal_code" label_input="Code postal" required="true" label_required="Obligatoire"/>
		</div>
		
		<div id="email" style="display:none">
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Contact.Emails.PRIMARY.Address"  label_input="Adresse e-mail" required="true" label_required="Obligatoire" allow_external_login_updates="true"/>
		</div>
			
			<rn:condition logged_in="false">
			<div id="email-details" style="display:none">
		<div id="first-name" style="display:none">
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Contact.Name.First"  label_input="Prénom" required="true" label_required="Obligatoire" allow_external_login_updates="true"/>
		</div>
		
		<div id="last-name" style="display:none">
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Contact.Name.Last"  label_input="Nom de famille" required="true" label_required="Obligatoire" allow_external_login_updates="true"/>
		</div>
		</div>
		</rn:condition>
		...
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Incident.Threads"  label_input="Entrez votre question ICI" required="true" label_required="Obligatoire"/> 
		</div>
		...
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Incident.c$orderno"  label_input="Numéro de commande" /> 
		</div>

		<div id="bike-serial" style="display:none">
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Incident.c$bike_serial_number"  label_input="Numéro de série du vélo" /> 
		</div>

		<div id="tablet-id" style="display:none">
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Incident.c$tablet_serial"  label_input="Numéro de série du la tablette" /> 
		</div>
		
		<div id="language" class="life_time_rank" style="display:none">
	<rn:widget path="custom/ResponsiveDesign/Language" name="Incident.c$language_shk" label_input="Preferred Response Language" default_value="1183" interface=30 required="true" label_required="Obligatoire"/>
		</div>  
		...
		L'option de chat en Fran&ccedil;ais n'est pas disponible pour le moment. Veuillez r&eacute;essayer pendant les heures de service de Chat en Fran&ccedil;ais indiqu&eacute;es ci-dessous ou s&eacute;lectionnez l'option en Anglais pour recevoir de l'aide maintenant.
		</div> 
		
		<div id="spanish-message-chat-not-available" style="display:none">
		L'option de chat en Fran&ccedil;ais n'est pas disponible pour le moment. Veuillez r&eacute;essayer plus tard, ou s&eacute;lectionnez l'option en Anglais pour recevoir de l'aide maintenant.
		</div>
		 ...
		 <rn:widget path="custom/ResponsiveDesign/SpanishChatHour" label_chat_hours ="Soutien à la clientèle" />  
		 </div>
		 ...
		 <rn:widget path="chat/ChatStatus" label_chat_available="Horaires d'ouverture du service de clavardage" />
		 <rn:widget path="custom/ResponsiveDesign/BbliveChatHour" label_chat_hours ="Beachbody en direct! Les heures de conversation de l'instructeur sont répertoriées ci-dessous." />  
		 </div>
...
<rn:widget path="custom/ResponsiveDesign/PhoneHourDetails" interface=30/>
</div>
...
<p>*Les résultats du bureau des Coachs en ligne sont mis à jour <br> plus fréquemment. Veuillez consulter le<br>Bureau du Coach en ligne pour des mises à jour quotidiennes.</p>
  ...
  <form id="rn_QuestionSubmit" method="post">
        ...
        <div class="form-dv">
       		     ...
       		     <div class="left-box">
                     <rn:widget path="custom/ResponsiveDesign/countrySelectionInput_OrderStatus" name="Contact.Address.Country" required="false" label_input = "Country/Pais/Pays" default_value='2' allow_external_login_updates="true"/>
                </div>
			  ...
			  <div class="left-box">
               ...
               <div class="right-box">
              	 <rn:widget path="custom/ResponsiveDesign/TextInputCO" name="CO.order_tracking_new.email" 
               	  label_input="Courriel électronique" required="false"/>    
                </div>
            ...
            <div class="form-dv"> 
                ...
                <div class="text-2">Étape 2:</div>
                	<rn:widget path="custom/ResponsiveDesign/TextInputCO" name="CO.order_tracking_new.zip_code" 
               		label_input="Code postal / postal / Code postal de livraison" required="false"/>
   ...
   <!-- <span class="close" onClick="closePopUp()"  style="display: none">X</span>-->
	...
	<div id="formdisplay" style="display: none">
		...
		<form id="form" onsubmit="return false">
				...
				<rn:widget path="input/TextInput" name="Contact.Name.First" required="true" label="Prénom" label_input="Prénom" allow_external_login_updates="true"/><br/>
				</div>
				<div id="lastName" style="display: none">	
				<rn:widget path="input/TextInput" name="Contact.Name.Last" required="true" label="Nom de famille" label_input="Nom de famille" allow_external_login_updates="true"/>
				</div><br/><br/><br/>
				<!---------------------------------Updated by jithin(below code) select credit card type based on country selection------------------------------------------>
				<div class="country">
				<rn:widget path="custom/ResponsiveDesign/countrySelectionInput_ccu" name="Contact.Address.Country" required="true" label_input = "Pays" default_value='2' allow_external_login_updates="true"/>
				</div>
				...
				<div class="">
					...
					<rn:widget path="custom/ResponsiveDesign/SelectionInputState" name="Contact.Address.StateOrProvince" label_input="Etat / Province" required="true" required="false" allow_external_login_updates="true"/>
					</div>
				</div>

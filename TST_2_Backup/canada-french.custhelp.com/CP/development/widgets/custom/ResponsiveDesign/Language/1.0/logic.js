...
Custom.Widgets.ResponsiveDesign.Language = RightNow.Widgets.SelectionInput.extend({ 
	...
	show_regular_chathours_details: function(type, args)
	{
		...
		if(channel_id=="1529")//chat with an agent
		{
			 ...
			 if(language_id==1183)//french  
			{
				var display_chat_hours =["spanish-chat-hours"];
		...
		{
				var regular_chat_hour =["regular-chat-hours","spanish-chat-hours","spanish-message-outbound-time","spanish-message-chat-not-available","language"];

...
class CustomChatHours extends \RightNow\Widgets\ChatHours {
	...
	/*------------------------------------BB Live Chat Customization Start-------------------------------------------------*/
	 	 ...
	 	 $rmas = RNCPHP\ROQL::queryObject("SELECT CO.CustomChatHours FROM CO.CustomChatHours WHERE CO.CustomChatHours.ID = 4")->next();     
		 $rma = $rmas->next();
	//echo "<pre>";
	//print_r($rma);
				...
				//	print_r($hours);  
					...
					$keys = array_values($hours);
						...
						//	echo $this->data['chatHours']['hours'][$i][0];
							...
							if($this->data['chatHours']['hours'][$i][0]=='Lundi - Vendredi')
								{
									$this->data['chatHours']['hours'][$i][0]='L-V';
								}
							if($this->data['chatHours']['hours'][$i][0]=='Lundi - Samedi')
								{
							...
							if($this->data['chatHours']['hours'][$i][0]=='Samedi - Dimanche')
								{
									...
									$this->data['chatHours']['hours'][$i][0]='Sam à Dim';

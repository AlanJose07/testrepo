        ...
        <fieldset>
            <legend id="rn_<?= $this->instanceID ?>_Label" class="rn_Label">
                <rn:block id="preLabel"/>
                        ...
                        {
						?>
						<h3 class="recommend-title">Voici comment obtenir de l'aide:</h3>	   
						<?
						}
...
function recommended_contact_us_channel($key,$value,$id,$selfservicedetails,$display_label_image,$selfservicetitle,$selfserviceicon,$selfservicedes,$email_description,$email_sla,$email_title,$doc_description,$doc_sla,$doc_title)
{
...
<? if($key=="1527"):?>  <!-- ask an expert -->
				...
				<div id="recommended-title-div">Recommandé</div>
		...
		<? if($key=="1529"):?>  <!-- chat with an agent -->
			 ...
			 <li class="chat-desktop">
				...
				<?php 
								 $complete_actual_link = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";  
								 $pattern = '/app/chat/prechatsurvey/';
								 $guesturl = str_replace('/app/contactus_support/',$pattern,$complete_actual_link);
					?>

				<a href= "<?php echo $guesturl ?>" >Continuer en tant qu'invité</a>

				<!--<a href= "javascript:void(0);" class= "continue disable-click prevent_loading_click">Continuer en tant qu'invité</a>-->
				</div>
		...
		<? if($key=="1885"):?>  <!-- Submit Document -->
		
		        <? $label_image=explode("->",$display_label_image['1885']);?>
				<li>
				<a href="javascript:void(0);" class="chat-email active-chat" id="<?= $id?>" onclick="click_tracking('Contact Us - Document ')">
				<div id="recommended-title-div">Recommended</div>
						
						<div class="chtrec-icon"><img src="/euf/assets/themes/responsive/images/contactus_channel_image/<?=$label_image[1]?>"></div>
						<!--<span><?= $label_image[0] ?></span>-->
						<span><?= $doc_title ?></span>
						<p class="self-service-availability"><?= $doc_description ?></p>
						<p><?= $doc_sla ?></p>
...
<? if($key=="1131"):?>  <!--Call me now-->
	   ...
	   ?>
<? $label_image=explode("->",$display_label_image['1131']);?>
	 ...
	 <!--  <div style="display:inline; position:relative"> -->
	 <li class="list">
		<a href="javascript:void(0);" class="callmenow active-chat disable-click-callmenow" id="<?= $id?>" onclick="click_tracking('Contact Us - Call Me Now')">
		<div id="recommended-title-div">Recommandé</div>
				
				<div class="chtrec-icon"><img src="/euf/assets/themes/responsive/images/contactus_channel_image/<?=$label_image[1]?>"></div>
				<span><?= $label_image[0] ?></span>
				<rn:widget path="custom/ResponsiveDesign/CallMeNowChatHours" label_chat_hours =" "/>
	...
	<!--	</div> -->
	   ...
	   <? $login_not_url = "/app/callmenow/".$text;
		
	   ?>
	   <li class="list">
		<a href="<?= $login_not_url ?>" class="callmenow active-chat disable-click-callmenow" id="<?= $id?>" onclick="click_tracking('Contact Us - Call Me Now')">
		<div id="recommended-title-div">Recommandé</div>
				
				<div class="chtrec-icon"><img src="/euf/assets/themes/responsive/images/contactus_channel_image/<?=$label_image[1]?>"></div>
				<span><?= $label_image[0] ?></span>
				<rn:widget path="custom/ResponsiveDesign/CallMeNowChatHours" label_chat_hours =" " page=1/>
...
function display_contact_us_channel($key,$value,$id,$selfservicedetails,$display_label_image,$selfservicetitle,$selfserviceicon,$selfservicedes,$email_description,$email_sla,$email_title,$doc_description,$doc_sla,$doc_title)
{
$TLP=explode(".",trim(getUrlParm('TLP')));
$toplevelcategory = trim($TLP[0]);
?>
...
<? if($key=="1527"):?>  <!-- ask an expert -->
		...
		<? if($key=="1529"):?>  <!-- chat with an agent -->
			...
			//https://ohsqa3.beachbody.com/oamfed/idp/initiatesso?providerid=OCS-QA3 ?>
				...
				<li class="chat-desktop">
					...
					?>
					<a href= "<?php echo $guesturl ?>" >Continuer en tant qu'invité</a>
				<!--	<a href= "javascript:void(0);" class= "continue prevent_loading_click">Continuer en tant qu'invité</a>-->
		...
		<? if($key=="1885"):?>  <!-- Submit Document-->
				...
				<? $label_image=explode("->",$display_label_image['1885']);?>
				<li>
				<a href="javascript:void(0);" class="chat-email" id="<?= $id?>" onclick="click_tracking('Contact Us - Document')">
	...
	//https://ohsqa3.beachbody.com/oamfed/idp/initiatesso?providerid=OCS-QA3 ?>
		...
		<!-- <div style="display:inline; position:relative"> -->
		<li>
			 <a href="javascript:void(0);" class="callmenow disable-click-callmenow" id="<?= $id?>" onclick="click_tracking('Contact Us - Call Me Now')">     
	   ...
	   ?>
		<li>
		<a href="<?= $login_not_url ?>" class="callmenow disable-click-callmenow" id="<?= $id?>" onclick="click_tracking('Contact Us - Call Me Now')">  
...
<? $email_title="null"; ?>
<? if($this->data['js']['email_title']!="null" ):?>
<? $email_title=$this->data['js']['email_title'];?>
<? endif;?>

<? $doc_description="null"; ?>
<? if($this->data['js']['doc_description']!="null" ):?>
<? $doc_description=$this->data['js']['doc_description'];?>
<? endif;?>

<? $doc_sla="null"; ?>
<? if($this->data['js']['doc_sla']!="null" ):?>
<? $doc_sla=$this->data['js']['doc_sla'];?>
<? endif;?>

<? $doc_title="null"; ?>
<? if($this->data['js']['doc_title']!="null" ):?>
<? $doc_title=$this->data['js']['doc_title'];?>
<? endif;?>
...
<? recommended_contact_us_channel($key,$value,$id,$selfservicedetails,$display_label_image,$selfservicetitle,$selfserviceicon,$selfservicedes,$email_description,$email_sla,$email_title,$doc_description,$doc_sla,$doc_title); ?>
...
<? display_contact_us_channel($key,$value,$id,$selfservicedetails,$display_label_image,$selfservicetitle,$selfserviceicon,$selfservicedes,$email_description,$email_sla,$email_title,$doc_description,$doc_sla,$doc_title); ?>

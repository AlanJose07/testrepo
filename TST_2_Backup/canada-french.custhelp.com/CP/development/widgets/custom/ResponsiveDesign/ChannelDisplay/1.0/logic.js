...
Custom.Widgets.ResponsiveDesign.ChannelDisplay = RightNow.Field.extend({ 
   overrides: {
        constructor: function(){
			...
			RightNow.Event.subscribe("fbHours",this.fbHours,this);
 ...
 */						
                    ...
                    successHandler: function(response) {
								...
								{
								window.location = 'https://canada-french--tst2.custhelp.com//cc/openlogin/oauth/authorize/beachbody?returnurl=smssurvey/'+encodeURIComponent(this.url_parameter);
								}else{
		 ...
		 */						
							...
							successHandler: function(response) {
										...
										if(response['loggedin'] ==  'no')
										{
										window.location = 'https://canada-french--tst2.custhelp.com//cc/openlogin/oauth/authorize/beachbody?returnurl=callmenow/'+encodeURIComponent(this.url_parameter);
										}
										else{
...

		{
				...
				{/*
						...
						this.selfserviceform_details=this.data.js.self_service_form_link_path.split('->');
								...
								if(this.selfserviceform_details[1]=="Vérifier le statut de ma commande" || this.selfserviceform_details[1]=="Mettre à jour ma carte de crédit")
								{
...
*/			
			RightNow.Ajax.makeRequest('/cc/bbresponsivecontroller/loginsession', {text:login_url}, {
                    successHandler: function(response) {
								...
								if(response['loggedin'] ==  'no')
								{ 
								window.location = 'https://canada-french--tst2.custhelp.com//cc/openlogin/oauth/authorize/beachbody?returnurl=chat/prechatsurvey/'+encodeURIComponent(this.url_parameter);
								}else{
...
*/
						...
						var displayNone =["coachid","phone-us", "phone-title","email-title","ask-title","facebook-title","after-submit-email","rn_errorlocation_chat","email-conf-title","file-upload","regular-chat-hours"];
						this._displayBlock(displayBlock);
						this._displayNone(displayNone);
...
*/			
			RightNow.Ajax.makeRequest('/cc/bbresponsivecontroller/loginsession_fb/facebook', {text:login_url}, {
                    successHandler: function(response) {
								...
								if(response['loggedin'] ==  'no')
								{ 
									window.location = 'https://canada-french--tst2.custhelp.com//cc/openlogin/oauth/authorize/beachbody?returnurl=chat/facebooksurvey/'+encodeURIComponent(this.url_parameter);
								}else{
...
*/
				       ...
				       // the first code comment and the second code created..
						...
						else
						{
							...
							else
							{
								 if(this.top_parent[0]=='3784') 
								 {
									 var displayBlock =["zipcode","email","first-name","last-name","submit-button","hide-for-email-confirm-popup","file-upload","lifetimerank","agent-help","membertype","myx-fields","order-no","bike-serial","tablet-id"];
				...
				else if(checked_channel=='1885')//Document 
		        {
					...
					if(this.data.js.isloggedin=="loggedin")
					{
						...
						var displayNone =["agent-help","phone-us","regular-chat-hours","spanish-chat-hours","spanish-message-outbound-time","spanish-message-chat-not-available","remove-callus-email","chat-title","phone-title","ask-title","after-submit-email","rn_errorlocation_chat","email-conf-title","email","first-name","last-name","language","order-no","bike-serial","tablet-id","zipcode","lifetimerank"];
					}
					else
					{
						var displayBlock =["coachid","bsf","email","first-name","last-name","submit-button","hide-for-email-confirm-popup","file-upload"];
						var displayNone =["agent-help","phone-us","regular-chat-hours","spanish-chat-hours","spanish-message-outbound-time","spanish-message-chat-not-available","remove-callus-email","chat-title","phone-title","ask-title","after-submit-email","rn_errorlocation_chat","email-conf-title","language","order-no","bike-serial","tablet-id","zipcode","lifetimerank"];
					}
					this._displayBlock(displayBlock);
					this._displayNone(displayNone);
...
*/
				...
				var displayNone =["phone-us","phone-title","email-title","ask-title","facebook-title","after-submit-email","rn_errorlocation_chat","email-conf-title","file-upload","regular-chat-hours"];
				this._displayBlock(displayBlock);
				this._displayNone(displayNone);
...
*/
		...
		else if(checked_channel=='1885')//Document 
		{
					...
					if(this.data.js.isloggedin=="loggedin")
					{
					     var displayBlock =["coachid","bsf","language","submit-button","hide-for-email-confirm-popup","file-upload",];
					...
					{
							var displayBlock =["coachid","bsf","email","first-name","last-name","language","submit-button","hide-for-email-confirm-popup","file-upload"];
						var displayNone =["agent-help","phone-us","regular-chat-hours","spanish-chat-hours","spanish-message-outbound-time","spanish-message-chat-not-available","remove-callus-email","chat-title","phone-title","ask-title","after-submit-email","rn_errorlocation_chat","email-conf-title","order-no","bike-serial","tablet-id","zipcode","lifetimerank"];
					}
					this._displayBlock(displayBlock);
					this._displayNone(displayNone);
					RightNow.Event.fire("file_attachement_field_required",channel);
...
*/
						...
						var displayNone =["coachid","phone-us", "phone-title","email-title","ask-title","facebook-title","after-submit-email","rn_errorlocation_chat","file-upload","email-conf-title","regular-chat-hours"];
						this._displayBlock(displayBlock);
						this._displayNone(displayNone);
...
*/			
			RightNow.Ajax.makeRequest('/cc/bbresponsivecontroller/loginsession_fb/facebook', {text:login_url}, {
                    successHandler: function(response) {
								...
								if(response['loggedin'] ==  'no')
								{ 
									window.location = 'https://canada-french--tst2.custhelp.com//cc/openlogin/oauth/authorize/beachbody?returnurl=chat/facebooksurvey/'+encodeURIComponent(this.url_parameter);								}else{
									window.location = '/app/chat/facebooksurvey/'+this.url_parameter;
								}

RightNow.namespace('Custom.Widgets.ResponsiveDesign.TextInputCOCreditCardUpdate');
Custom.Widgets.ResponsiveDesign.TextInputCOCreditCardUpdate = RightNow.Field.extend({
    overrides: {
        constructor: function(data, instanceID) {
			...
			if(this._fieldName == "email")
			{
				...
				document.getElementById(email_field_id).placeholder=this.data.attrs.label_input;/*"Email"; */
			...
			if(this._fieldName == "zip_code")
			{
				...
				document.getElementById(zip_field_id).placeholder=this.data.attrs.label_input;/*"Zip / Post / Postal code of Shipping Address";*/

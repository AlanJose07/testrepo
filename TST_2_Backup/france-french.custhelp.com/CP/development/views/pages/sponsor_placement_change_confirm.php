    		...
    		<div class="rn_wrap">   
					...
					<div id="confirm_eng">
						...
						<div style="font-size:15px;">
							<ul>
								<li>Nous étudierons votre demande et vous répondrons par e-mail d’ici deux jours ouvrables. </br> </br> </li>
								<li>Votre numéro de dossier est le <b><?= $referencenumber ?></b> </li>
							</ul>
						</div> 
					</div>

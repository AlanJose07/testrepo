...
*/			
			RightNow.Ajax.makeRequest('/cc/bbresponsivecontroller/loginsession', {text:login_url}, {
                    successHandler: function(response) {
								...
								{ 
								window.location = 'https://france-french--tst2.custhelp.com/cc/openlogin/oauth/authorize/beachbody?returnurl=chat/prechatsurvey/'+encodeURIComponent(this.url_parameter);
								}else{
...
*/			
			RightNow.Ajax.makeRequest('/cc/bbresponsivecontroller/loginsession_fb/facebook', {text:login_url}, {
                    successHandler: function(response) {
								...
								if(response['loggedin'] ==  'no')
								{ 
									window.location = 'https://france-french--tst2.custhelp.com/cc/openlogin/oauth/authorize/beachbody?returnurl=chat/facebooksurvey/'+encodeURIComponent(this.url_parameter);
								}else{
...
*/
				       ...
				       // the first code comment and the second code created..
						...
						else
						{
							...
							console.log("Email us option");
							console.log(this.data.js.isloggedin);
							this.showForm();
...
*/
					...
					RightNow.Ajax.makeRequest('/cc/bbresponsivecontroller/loginsession_fb/email', {text:login_url}, {
                    successHandler: function(response) {
								...
								if(response['loggedin'] ==  'no')
								{
								//window.location = pta_login;
								window.location = 'https://france-french--tst2.custhelp.com/cc/openlogin/oauth/authorize/beachbody?returnurl=submit_document/'+encodeURIComponent(this.url_parameter);
								}else{
									window.location = '/app/submit_document/'+this.url_parameter;
								}

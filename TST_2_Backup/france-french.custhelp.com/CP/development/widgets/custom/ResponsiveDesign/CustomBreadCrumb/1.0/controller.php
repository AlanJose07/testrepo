...
class CustomBreadCrumb extends \RightNow\Libraries\Widget\Base {
	...
	if($catParentIdFirst!="")// FIRST LEVEL 
	{
	 ...
	 {
	 $queryFirstAnswer="SELECT BB.categ_contac_hom_fra.answer_report_id FROM BB.categ_contac_hom_fra bbb WHERE bbb.enable=1 and bbb.visible_on_page.LookupName='$visible_on_page_parent' and bbb.category.ID=".$catParentIdFirst;
	 }
	 else
	 {
	 
	 //---answer id--
	$queryFirstAnswer="SELECT BB.categ_contac_hom_fra.answer_report_id FROM BB.categ_contac_hom_fra bbb WHERE bbb.enable=1 and bbb.visible_on_page.LookupName='$visible_on_page' and bbb.category.ID=".$catParentIdFirst;
	}
	 ...
	 //--------------
	  //================REMOVE ANSWER ID SECTION=========
		 ...
		 if($categoryParentIdSecond!="")//SECOND LEVEL
		 {
			...
			{
			$querySecondAnswer="SELECT BB.categ_contac_hom_fra.answer_report_id FROM BB.categ_contac_hom_fra bbb WHERE bbb.enable=1 and bbb.visible_on_page.LookupName='$visible_on_page_parent' and bbb.category.ID=".$categoryParentIdSecond;
			}
			else
			{
			 //---answer id--
			$querySecondAnswer="SELECT BB.categ_contac_hom_fra.answer_report_id FROM BB.categ_contac_hom_fra bbb WHERE bbb.enable=1 and bbb.visible_on_page.LookupName='$visible_on_page' and bbb.category.ID=".$categoryParentIdSecond;
			}
			...
			$categoryParentIdFourth=$categoryThird["Parent"];	
			 ...
			 //================REMOVE ANSWER ID SECTION=========
				...
				{
				$queryThirdAnswer="SELECT BB.categ_contac_hom_fra.answer_report_id FROM BB.categ_contac_hom_fra bbb WHERE bbb.enable=1 and bbb.visible_on_page.LookupName='$visible_on_page_parent' and bbb.category.ID=".$categoryParentIdThird;
				}
				else
				{
						//---answer id--
				$queryThirdAnswer="SELECT BB.categ_contac_hom_fra.answer_report_id FROM BB.categ_contac_hom_fra bbb WHERE 		bbb.enable=1 and bbb.visible_on_page.LookupName='$visible_on_page' and bbb.category.ID=".$categoryParentIdThird;
				}
			...
			{
			$queryFourthAnswer="SELECT BB.categ_contac_hom_fra.answer_report_id FROM BB.categ_contac_hom_fra bbb WHERE bbb.enable=1 and bbb.visible_on_page.LookupName='$visible_on_page_parent' and bbb.category.ID=".$categoryParentIdFourth;
			}
			else
			{
			$queryFourthAnswer="SELECT BB.categ_contac_hom_fra.answer_report_id FROM BB.categ_contac_hom_fra bbb WHERE bbb.enable=1 and bbb.visible_on_page.LookupName='$visible_on_page' and bbb.category.ID=".$categoryParentIdFourth;
			}
			...
			//================REMOVE ANSWER ID SECTION=========
						...
						{
						$queryFifthAnswer="SELECT BB.categ_contac_hom_fra.answer_report_id FROM BB.categ_contac_hom_fra bbb WHERE bbb.enable=1 and bbb.visible_on_page.LookupName='$visible_on_page_parent' and bbb.category.ID=".$categoryParentIdFifth;
						}
						else
						{
								//---answer id--
						$queryFifthAnswer="SELECT BB.categ_contac_hom_fra.answer_report_id FROM BB.categ_contac_hom_fra bbb WHERE bbb.enable=1 and bbb.visible_on_page.LookupName='$visible_on_page' and bbb.category.ID=".$categoryParentIdFifth;
						}
						...
						{
						$querySixthAnswer="SELECT BB.categ_contac_hom_fra.answer_report_id FROM BB.categ_contac_hom_fra bbb WHERE bbb.enable=1 and bbb.visible_on_page.LookupName='$visible_on_page_parent' and bbb.category.ID=".$categoryParentIdSeventh;
						}
						else
						{
						//---answer id--
						$querySixthAnswer="SELECT BB.categ_contac_hom_fra.answer_report_id FROM BB.categ_contac_hom_fra bbb WHERE bbb.enable=1 and bbb.visible_on_page.LookupName='$visible_on_page' and bbb.category.ID=".$categoryParentIdSeventh;
						}

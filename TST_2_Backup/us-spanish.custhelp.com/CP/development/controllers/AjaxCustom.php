...
$this->_renderJSON(array('errors' =>'error','display_chat' => $display_chat));
	...
	//====added  for new form=====
	    ...
	    public function sendFormGDPR()
		{
			...
			$result = $this->_echoJSON($this->model('custom/Field_beachbody_custom')->sendForm($data,$thread_text, $thread_text2,$listOfUpdateRecordIDs ?: array(), ($smartAssistant === 'true'))->toJson());

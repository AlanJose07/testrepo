...
<div id="answers" class="answer_list">
  <div class="container" >
      <!--<rn:container report_id='130168'>-->
      <rn:container report_id='143299'> <!--130168--> 
      <div class="rn_Padding">
	   ...
	   <rn:widget path="custom/ResponsiveDesign/CategorySearchFilterTreeView" filter_type = "categories" label_nothing_selected="Selecciona Una Categoria" label_input="Filtra Por Categoria" search_on_select ="true" static_filter="c=#rn:php:$catid#"/>
	   
	   <!-- no result found section[below]-->
	   <rn:widget path="reports/ResultInfo" show_no_results_msg_without_search_term="true" label_no_results="No se han encontrado resultados."/>
	  <!-- no result found section[above]-->
	  
	   <!--<rn:widget path="custom/ResponsiveDesign/CustomMultiline" per_page="10"  static_filter="c=#rn:php:$catid#"/>-->
	   <rn:widget path="custom/ResponsiveDesign/CustomMultiline" per_page="10"  static_filter="c=#rn:php:$catid#" truncate_size="200" label_screen_reader_search_no_results_alert="Your search returned no results"/>
		<rn:widget path="custom/ResponsiveDesign/PaginatorGeneric" per_page="10" report_id="143299"  static_filter="c=#rn:php:$catid#"/>  

	<!-- <rn:widget path="custom/ResponsiveDesign/CustomPaginator" per_page="10" />-->

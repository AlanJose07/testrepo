...
<div id="answers" class="answer_list" style="min-height: 395px;">
  <div class="container" >
      <!--<rn:container report_id='130161'> -->
      <!---changed by sriram-->
      <!--<rn:container report_id='143201'>-->
      <rn:container report_id='143201'>
      <div class="rn_Padding">
        ...
        <div id="mpa_title">Respuestas más populares</div>
	  ...
	  <!-- no result found section[above]-->
        ...
        <rn:widget path="custom/ResponsiveDesign/CustomPaginator" per_page="10"  report_id='143201' static_filter="c=#rn:php:$catid#"/>

...
try{
	...
	window.opener.location = 'https://faq.es.beachbody.com/app/home';
                ...
                <rn:widget path="chat/ChatOffTheRecordDialog"/>
                    ...
                    <div id="rn_ChatDialogHeaderContainer">
                        ...
                        <div id="rn_ChatDialogHeaderButtonContainer">
                            ...
                            <!--<rn:widget path="input/ChatSoundExtended"/>-->
							...
							<!--
							Changes to the CSS needed during prod deployment
							1. chat_landing_style.css
								Comment line no: 53 
								#rn_ChatDialogHeaderContainer #rn_ChatDialogHeaderButtonContainer button:hover {
									background-color: #00559a;
								}
								Line no: 117
								.rn_ChatTranscript .rn_MessagePost br {display:none}
								#rn_ChatDialogHeaderContainer #rn_ChatDialogHeaderButtonContainer button img {
									display: block;
									height: 20px;
									width: 20px;
								}
					...
					<div id="rn_ChatDialogTitle" class="rn_FloatLeft">Gracias por contactar al Chat de Beachbody<!--#rn:msg:CHAT_LBL#--></div>
					<!--commented by sriram-->
                    <!--<rn:widget path="chat/ChatServerConnect" email_required="true"  label_prevent_anonymous_chat="Email Address is required"/>-->
					<rn:widget path="chat/ChatServerConnect" email_required="true"  label_prevent_anonymous_chat="Se requiere Dirección de correo electrónico"/>
					...
					<rn:widget path="custom/ResponsiveDesign/ChatPostMessageFocus" initial_focus="false" label_send_instructions="Escribe tu mensaje aquí..." focus_on_incoming_messages="true"/>

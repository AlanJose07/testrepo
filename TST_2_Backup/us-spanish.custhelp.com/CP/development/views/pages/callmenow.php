    ...
    <div id="rn_ChatContainer">
        ...
        <div id="rn_PageContent" class="rn_Live">
            <div class="rn_Padding">
					...
					<div id="rn_SmsTitle" class="rn_FloatLeft">Inicia sesión para continuar con la función Llámame.</div>
					</rn:condition>
	    ...
	    <? $catid= getUrlParm('catid');
           ...
           $homephone_array = $this->model('custom/bbresponsive')->contact_homeph_fetch($c_id);

		   if (is_array($homephone_array)){
			
			$homephone_1 = $homephone_array['Number'];
			}
			else{
				$homephone_1 = $homephone_array ;
			}
...
*/
		...
		<rn:condition logged_in="true">
				...
				<div id="rn_SmsTitle" class="rn_FloatLeft"><?php echo "Hola ".$this->session->getProfile()->first_name->value.", Confirma tu numero para comenzar." ?></div>
			...
			<!--<div id="agent-help" style="display:block">
				...
				#rn:msg:CUSTOM_MSG_CALL_ME_TEXT#
				
				</div>
									
				<div id="submit-button" style="display:block">
				<rn:widget path="custom/ResponsiveDesign/Submit" label_button="Llámame" error_location="rn_errorlocation_chat" on_success_url='/app/home'/>	
				</div>
				<div id="sms-rates" style="text-align:left !important;padding-bottom:30px !important;">
				
				Asegúrate de que la configuración de tu teléfono acepte llamadas de números desconocidos.
...
<div class="modal-content Bb_modal">
  ...
  <div id="headingOrder"></div>    
   ...
   Recomendamos utilizar “Llámame” para recibir apoyo más rápido. Un agente podrá atenderte según las selecciones que hayas indicado.   </p>
   <p style="font-size: 16px;text-align:left;">
   Si prefieres llamar al departamento de Apoyo de Beachbody, ten en cuenta que se te harán una serie de preguntas para verificar tu identidad, así como para revisar las opciones de nuestro menú.   </p>
   <p style="font-size: 16px;text-align:left;">

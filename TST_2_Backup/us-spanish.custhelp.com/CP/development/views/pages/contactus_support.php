...
<form id="rn_ChatLaunchForm" method="post" action="">
		...
		<div class="overlay-form" id="self-service">
		 ...
		 <h1 id="chat-title" style="display:none">Soporte de Chat</h1>  
		 <h1 id="phone-title" style="display:none">Llame a Soporte</h1>
		 <h1 id="doc-title" style="display:none">Envía un Documento</h1>
		 <h1 id="email-title" style="display:none">Envíanos un Email</h1>
		 <h1 id="email-conf-title" style="display:none">confirmación de correo electrónico</h1>
		...
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Incident.c$coachcustomernumber" label_input="Identificación del entrenador" required="true"/>
		</div>  
		...
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Incident.c$orderno"  label_input="Número De Orden." /> 
		</div>

		<div id="bike-serial" style="display:none">
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Incident.c$bike_serial_number"  label_input="Número de serie de la bicicleta." /> 
		</div>

		<div id="tablet-id" style="display:none">
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Incident.c$bike_serial_number"  label_input="Número de serie de la tableta." /> 
		</div>
		
		<div id="hidden_category" style="display:none">
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Incident.c$free_text"  label_input="¿Cómo puede ayudarlo nuestro agente hoy?"  default_value="#rn:php:$catid#"/> 
		</div>
		<div id="language" class="life_time_rank" style="display:none">
			<rn:widget path="custom/ResponsiveDesign/Language" name="Incident.c$language_shk" label_input="Lenguaje de respuesta preferido" default_value="1184" interface=29 required="true"/>
		</div>
...
<rn:widget path="custom/ResponsiveDesign/PhoneHourDetails" interface=29/>
</div>
...
<div class="slide-form-head">
<h1 id="ask-title" style="display:none">Pregunte a un experto</h1>
<span class="close-reccomend" onclick="redirect_from_email()">X</span> </div>
<div class="container">
<div class="row chat-agent">
<div class="sliderform-wrap">
...
<div class="material-form ask-an-expert-div js-wrapper">
   ...
   <div id="rn_ErrorLocation_directly" style="display:none" ></div>
      <form id="expertForm" class="contactForm" method="post" action="javascript:;">   
		...
		<div id="div_ask_text">
		Pídale ayuda a un experto con preguntas generales. Los expertos son compañeros
clientes, seleccionados a mano según su conocimiento y experiencia.<br /><br />
		Para asistencia con su orden o cuenta, por favor chatee con un agente.
		</div>	  
		...
		<label class="contactForm__label" for="directlyChannelName">Nombre de pila<span class="rn_Required"> *</span></label>
		<input type="text" id="directlyChannelFirstName" class="form-control contactForm__input js-contact-input">
		</div>
					
		<div class="input-block floating-field contactForm__inputGroup">
		<label class="contactForm__label" for="directlyChannelName">Apellido<span class="rn_Required"> *</span></label>
		<input type="text"  id="directlyChannelLastName" class="form-control contactForm__input js-contact-input">
		</div>
					
		<div class="input-block floating-field contactForm__inputGroup">
		<label class="contactForm__label" for="directlyChannelEmail">Dirección de correo electrónico <span class="rn_Required"> *</span></label>
		...
		<label class="contactForm__label" for="directlyChannelQuestion">Tu pregunta<span class="rn_Required"> *</span></label>
		...
		<p class="contactForm__submitGroup">
			<button class="btn square-button material-btn button" type="submit" onclick="ask_validation();">Pregunte a un experto</button>
		</p>
...
function ask_validation()
{
	...
	if(document.getElementById("directlyChannelLastName"))
	{
		...
		if(firstname == "")
		{
			document.getElementById("rn_ErrorLocation_directly").innerHTML +="<div onclick='setFocus(4)'><a style='cursor:pointer'><b>Se requiere el primer nombre"+"</b></a></div>";
		...
		if(lastname == "")
		{
			document.getElementById("rn_ErrorLocation_directly").innerHTML +="<div onclick='setFocus(5)'><a style='cursor:pointer'><b>El apellido es obligatorio"+"</b></a></div>";
		...
		if(email == "")
		{
			...
			document.getElementById("rn_ErrorLocation_directly").innerHTML +="<div onclick='setFocus(2)'><a style='cursor:pointer'><b>Se requiere Dirección de correo electrónico"+"</b></a></div>";
		...
		if(email!= "")
		{
			...
			if (atpos<1 || dotpos<atpos+2 || dotpos+2>=email.length) 
			{
				...
				document.getElementById("rn_ErrorLocation_directly").innerHTML +="<div onclick='setFocus(2)'><a style='cursor:pointer'><b>Dirección de correo electrónico es inválida"+"</b></a></div>";
		...
		if(question == "")
		{
			...
			document.getElementById("rn_ErrorLocation_directly").innerHTML +="<div onclick='setFocus(3)'><a style='cursor:pointer'><b>La pregunta es obligatoria"+"</b></a></div>";
  ...
  <div class="modal-content Bb_modal">
   ...
   <!-- <span class="close" onClick="closePopUp()"  style="display: none">X</span>-->
	<span class="close" onClick="closePopUp()">X</span>
	 <div class="cmp_logo"><img src="/euf/assets/images/beachbody_logo_site.png"></div>
	<div id="heading">Actualización de tarjeta de crédito</div>
	...
	<div id="formdisplay" style="display: none">
		...
		<form id="form" onsubmit="return false">
				...
				<div class="clsCardTypes">
    				...
    				<div class="clsCardDetails"><p>Por favor ingrese los detalles de su nueva tarjeta</p>
				...
				<rn:widget path="custom/ResponsiveDesign/countrySelectionInput_ccu" name="Contact.Address.Country" required="true" label_input = "País" default_value='1' allow_external_login_updates="true"/>
				</div>
				...
				<div class="">
					...
					<rn:widget path="custom/ResponsiveDesign/SelectionInputState" name="Contact.Address.StateOrProvince" label_input="Estado / Provincia" required="true" required="false" allow_external_login_updates="true"/>
					</div>
				</div>

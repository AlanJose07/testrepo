...
{
	var req_eng="es requerido";
	if(membertypeid == 771){ // YES
		if(this.data.js.name == "Incident.CustomFields.c.ccc_transfer_coach_name"){
			this._makeRequired("Nombre del partner de BODi",true,req_eng);
		}
		if(this.data.js.name == "Incident.CustomFields.c.ccc_transfer_coach_email"){
			this._makeRequired("Correo electrónico del partner de BODi",true,req_eng);
		}
	}else{
		if(this.data.js.name == "Incident.CustomFields.c.ccc_transfer_coach_name")
			this._makeRequired("Nombre del partner",false,req_eng);
		if(this.data.js.name == "Incident.CustomFields.c.ccc_transfer_coach_email")	
			this._makeRequired("Correo electrónico del partner",false,req_eng);
	}

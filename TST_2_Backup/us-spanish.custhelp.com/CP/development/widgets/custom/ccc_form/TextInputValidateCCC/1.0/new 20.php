	...
	<a target="_blank" href="https://faq.beachbody.com/app/answers/detail/a_id/1488/kw/1488/~/sponsor-change-requirements-%2f-process-time/lob/coach" style="color: #0000ff;">FAQ 1488</a>
						...
						<!--------Would you like to transfer the credit of  recent order to  new Coach------>	
							<div id="tvc_cust_eng" style="display:none">
	  ...
	  <br />
					...
					<!-------------------------------------------------------------------------------->
							...
							<div id="tvc_cust_fre" style="display:none">
							<rn:widget path="custom/customercoachchange/SelectionInputLanguage" name="Incident.CustomFields.c.ccc_transfer_vc_fre" label_input =" Voudriez-vous transférer le crédit de votre commande récente à votre nouveau coach? " required="false"/>
		  ...
		  Les clients peuvent transférer leurs commandes de Beachbody.com ou directes à un compte de coach s'ils répondent aux critères suivants :
						...
						<!-------------------------------------------------------------------------------->
							...
							<div id="tvc_cust_spa" style="display:none">
							<rn:widget path="custom/customercoachchange/SelectionInputLanguage" name="Incident.CustomFields.c.ccc_transfer_vc_spa" label_input =" ¿Deseas transferir el crédito de tu pedido reciente a tu nuevo coach?" required="false"/>
	 ...
	 <br />
						...
						<div id="coach_spa_sub_head2" style="display:none"><h3> Debes proporcionar al menos uno de los siguientes datos:</h3><br /></div>
							...
							<rn:widget path="custom/customercoachchange/SelectionInputLanguage" name="Incident.CustomFields.c.ccc_transfer_vc_fre" label_input ="Transférez le volume et la commission de la commande du client"required="false"/>
	 ...
	 <br />
							...
							<rn:widget path="custom/customercoachchange/SelectionInputLanguage" name="Incident.CustomFields.c.ccc_transfer_vc_spa" label_input ="Transferir el volumen y la comisión del pedido del cliente"required="false"/>				
	  ...
	  <br />
					...
					<!-----------------Div for transfer volume and commission dropdown---------------------------->
							...
							<!--<rn:widget path="custom/customercoachchange/SelectionInputLanguage" name="Incident.CustomFields.c.ccc_transfer_vc_fre" label_input ="Transférez le volume et la commission de la commande du client"/>-->	
					<!--<rn:widget path="custom/customercoachchange/SelectionInputLanguage" name="Incident.CustomFields.c.ccc_transfer_vc_spa" label_input ="Transferir el volumen y la comisión del pedido del cliente"/>-->
					   <!-- </div>	-->

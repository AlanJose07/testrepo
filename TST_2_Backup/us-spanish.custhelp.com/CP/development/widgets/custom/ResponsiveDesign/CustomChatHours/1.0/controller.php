				...
				//	print_r($hours);  
					...
					$keys = array_values($hours);
						...
						//	echo $this->data['chatHours']['hours'][$i][0];
							...
							if($this->data['chatHours']['hours'][$i][0]=='Lunes - Viernes')
								{
									$this->data['chatHours']['hours'][$i][0]='L-V';
								}
							if($this->data['chatHours']['hours'][$i][0]=='Lunes - Sábado')
								{
									$this->data['chatHours']['hours'][$i][0]='L-S';
								}
								
								
							if($this->data['chatHours']['hours'][$i][0]=='Sábado - Domingo')
								{
									
									$this->data['chatHours']['hours'][$i][0]='Sáb y Dom';
									
								}
							if($this->data['chatHours']['hours'][$i][0]=='Domingo')
								{
									
									$this->data['chatHours']['hours'][$i][0]='Dom';
									
								}	
								
						    if($this->data['chatHours']['hours'][$i][1]!='24 horas' && $this->data['chatHours']['hours'][$i][1]!='Cerrado')
						{
		  ...
		  if($chat_count > 0)//if array is not null
					{
						...
						//if current time is in between the start or end time
							...
							else
							{
								...
								$this->data['js']['bbliveopen']= 'Abierto: '; 
							}

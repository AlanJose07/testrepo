...
class CustomMultiline extends \RightNow\Widgets\Multiline {
    ...
    function getData() {
		...
		for ($x = 0; $x <= $limit-1; $x++) 
		{
			...
			$final_str_len =  strlen(substr(strip_tags($results['data'][$x][1]),0,$this->data['attrs']['truncate_size']));

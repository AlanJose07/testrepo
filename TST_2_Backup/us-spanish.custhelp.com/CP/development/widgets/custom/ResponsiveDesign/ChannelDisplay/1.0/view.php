        ...
        <fieldset>
            <legend id="rn_<?= $this->instanceID ?>_Label" class="rn_Label">
                <rn:block id="preLabel"/>
                        ...
                        {
						?>
						<h3 class="recommend-title">Obtén Ayuda Aquí</h3>	   
						<?
						}
...
<? if($key=="1527"):?>  <!-- ask an expert -->
				...
				<div id="recommended-title-div">Recomendado</div>
		...
		<? if($key=="1529"):?>  <!-- chat with an agent -->
			 ...
			 <li class="chat-desktop">
				...
				<?php 		
					...
					?>		
				<a href= "<?php echo $guesturl ?>" >Continuar como invitado</a>					
			    </div>
			<!--	<a href= "javascript:void(0);" class= "continue disable-click prevent_loading_click">Continuar como invitado</a>-->
...
<? if($key=="1527"):?>  <!-- ask an expert -->
		...
		<? if($key=="1529"):?>  <!-- chat with an agent -->
			...
			//https://ohsqa3.beachbody.com/oamfed/idp/initiatesso?providerid=OCS-QA3 ?>
				...
				<!--	<a href= "javascript:void(0);" class= "continue prevent_loading_click">Continuar como invitado</a>-->
					</div>

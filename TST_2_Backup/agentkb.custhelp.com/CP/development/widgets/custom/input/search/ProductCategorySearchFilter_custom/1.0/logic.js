...
RightNow.namespace('Custom.Widgets.search.ProductCategorySearchFilter_custom');
Custom.Widgets.search.ProductCategorySearchFilter_custom = RightNow.SearchFilter.extend({
    overrides: {
    ...
    */
    ...
    {
        var hierValues, field, desc, descElement;
        ...
        {
            this._displayFieldVisibleText.set('innerHTML', this.data.attrs.label_nothing_selected);
            desc = this.data.attrs.label_nothing_selected;
        }
        else
        {
            hierValues = this._getSelectedNodesMessage().join("<br>");
            this._displayFieldVisibleText.set('innerHTML', hierValues);
            desc = this.data.attrs.label_screen_reader_selected + hierValues;
        }

        descElement = this.Y.one(this.baseSelector + "_TreeDescription");
        if (descElement) {
            descElement.set('innerHTML', desc);
        }

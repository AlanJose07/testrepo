...
<? else: ?>
    ...
    <? else: ?>
        ...
        <? endif; ?>
        <rn:block id="preInput"/>
		<? if($this->data['js']['name'] == 'cf_cust_product' || $this->data['js']['name'] == 'cf_send_return_label' || $this->data['js']['name'] == 'cf_comp_request' || $this->data['js']['name'] == 'cf_photo_evidence' || $this->data['js']['name'] == 'cf_injury_compensation'): ?>
			<? for($i = 2; $i >= 0; $i--):

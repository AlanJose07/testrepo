...
Custom.Widgets.search.SearchButton_custom = RightNow.Widgets.SearchButton.extend({ 
    ...
    overrides: {
		...
		{
			console.log("dsdsdsdddddddddddddddddddddd teeeeeeeeeeeeeeeeeee")
			...
			for (i=0; i<elLength; i++)
			{
				...
				console.log(SearchForm.elements[i].checked);
					NoOfcheckbox  += 1;
				}
				
			}
		console.log(NoOfcheckbox);
	   ...
	   this._Get_No_of_checkBox_Checked();
		...
		_disableClickListener: function() {
			console.log('_disableClickListener');

...
<? else: ?>
    ...
    <div id="rn_<?= $this->instanceID ?>_Guide<?= $this->data['guideID'] ?>" class="rn_Guide">
        ...
        <div id="rn_<?= $this->instanceID ?>_Question<?= $questionID ?>" class="rn_Node1 rn_Question1">
            <rn:block id="questionTop"/>
            <div class="rn_QuestionText1">
                <?= $question->text ?>
            </div>
        ...
        <? break;
            ...
            <div id="rn_<?= $this->instanceID ?>_Response<?= $questionID ?>" class="rn_Response rn_RadioQuestion1">
                <fieldset>
                    <legend>
                        <span class="rn_ScreenReaderOnly"><?= $question->taglessText ?></span>
                    </legend>

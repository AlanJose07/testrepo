...
<div id="rn_Container" >
    ...
    <div id="rn_Header" role="banner">
        ...
        <div id="rn_Logo"><a href="/app/#rn:config:CP_HOME_URL##rn:session#"><span class="rn_LogoTitle">#rn:msg:SUPPORT_LBL#</span></a></div>
		<!--Varun - Comment out Login-->
    ...
    <rn:condition hide_on_pages="utils/help_search">
        <div id="rn_NavigationBar" role="navigation">
			...
			<!--Varun - Commented out Home tab ends here-->
                <li><rn:widget path="navigation/NavigationTab" label_tab="#rn:msg:ANSWERS_HDG#" link="/app/answers/list" pages="answers/list, answers/detail, answers/intent"/></li>
                 <!-- <li><rn:widget path="navigation/NavigationTab" label_tab="Live Help" link="/app/chat/chat_launch" pages="answers/list, answers/detail, answers/intent , chat/chat_launch"/></li> -->
				<!--Varun - Comment out community-->
				...
				<!--Varun - Comment out Account ends here-->
            </ul>
        </div>
    </rn:condition>
    </div>
    <div id="rn_Body">
		...
		<!--Varun - Comment out Sidebar ends here-->
    </div>

...
<div id="rn_PageContent" class="">
	<?php /*
			...
			seed_data=#rn:php:$seedDataJson#
			*/
	?>
	
	
	
	<rn:widget path="custom/opa/OPAWidget" policy_model = "Form Printing"  web_determinations_url =  "https://beachbodyopa--tst2.custhelp.com/web-determinations" init_id = "" locale="en-US"  />

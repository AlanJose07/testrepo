...
.submit_gdpr input[type=submit], button {
...
<div id="rn_PageContent" class="rn_Live ask-page">
	<div class="rn_Padding" >
		<form id="rn_QuestionSubmit_GDPR" method="post" action="/ci/ajaxCustom/sendFormGDPR">	
			<p style="text-align: justify;">Please complete this form to initiate your request regarding the data Beachbody has collected and maintains on your account.  A Beachbody representative may contact you to validate this information or to ask for additional details necessary to handle your request.<br/><br/>Please fill out all required information accurately as we will use it to validate your identity. Your request may be delayed or declined if we receive incorrect information. <br/><br/>Answers to frequently asked questions regarding data subject rights may be found in </span><a href='/app/answers/detail/a_id/3436' target='__blank'>FAQ 3436</a>.<br/></p>

			<p style="text-align: justify;">You will receive an email from Beachbody after the form is submitted. The email will request that you click a link to verify your identity and protect you against fraud. Your request will be processed once you click the link.<br/></p>
			...
			<rn:widget path="custom/input/SelectGDPR" name="Incident.c$gdpr_us_states" required="false" label_input=" Select State of Residence"  initial_focus="true" allow_external_login_updates="true"/> </div>
			...
			<div id="authFields" style="display:none">
					...
					<rn:widget path="custom/input/TextGDPR" name="Incident.c$search_first_name" label_input="Authorized Agent First Name"  allow_external_login_updates="true" required="false"/>
					<rn:widget path="custom/input/TextGDPR" name="Incident.c$search_last_name" label_input="Authorized Agent Last Name" allow_external_login_updates="true" required="false"/>					
					</div>
					<div id="auth_email_fields">
					<rn:widget path="custom/input/TextGDPR" name="Incident.c$search_email" initial_focus="false" label_input="Authorized Agent Email Address" allow_external_login_updates="true" required="false"/>
					</div><br/>
			</div>
				...
				<div id="update_object_data" style="display:none">
					<div id="desc_uk" style="display:none;text-align:justify"><span><b>Describe in detail what data you would like to correct in the box below (e.g., updating your address or phone number).<br/><br/></b></span><br/><span style='color:red'><b>DO NOT include any sensitive information (i.e. credit card number, social security or insurance number, bank account number, etc.).</b></span><span><b> To update your payment card information, please go to <a style="text-decoration-line: underline !important;" target='__blank' href='http://www.beachbodysupport.com'>www.BeachbodySupport.com</a> and click on "Update Credit Card". To update your social security number, social insurance number, tax identification number or bank account information, please read </span><a style="text-decoration-line: underline !important;" href='/app/answers/detail/a_id/4644' target='__blank'>FAQ 4644</a>.</b></div>
					
						<div id="desc" style="display:none;text-align:justify"><span><b>Describe in detail what data you would like to correct in the box below (e.g., updating your address or phone number).<br/><br/></b></span><span style='color:red'><b>DO NOT include any sensitive information (i.e. credit card number, social security or insurance number, bank account number, etc.).</b></span><span><b> To update your payment card information, please go to <a style="text-decoration-line: underline !important;" target='__blank' href='http://www.beachbodysupport.com'>www.BeachbodySupport.com</a> and click on "Update Credit Card". To update your social security number, social insurance number, tax identification number or bank account information, please read </span><a style="text-decoration-line: underline !important;" href='/app/answers/detail/a_id/4644' target='__blank'>FAQ 4644</a>.</b></div>
				...
				<div id="delete_object_data" style="display:none">
						<div id="desc" style="text-align: left; text-align:justify;">
							<span style="color: red; text-align:left;"><b>To exercise the right to deletion, you must first cancel your Team Beachbody Coach account as required by Beachbody’s standard business practices. Please see FAQ [<a target='__blank' href='/app/answers/detail/a_id/9659'>9659</a>/<a target='__blank' href='/app/answers/detail/a_id/3544'>3544</a>] for more information on how to cancel your Coach account.<br/><br/>Once your Coach account is successfully cancelled, you may request deletion of your information as follows:</b></span><br/>
                ...
                <div id="delete_object_data_pc" style="display:none">
                        <div id="desc" style="text-align: left; text-align:justify">
                            <span style="color: red; text-align:left"><b>To exercise the right to deletion, you must first cancel your Team Beachbody Preferred Customer account as required by Beachbody’s standard business practices. Please see <a target='__blank' href='/app/answers/detail/a_id/3544'>FAQ 3544</a> for more information on how to cancel your Preferred Customer account.<br/><br/>Once your Preferred Customer account is successfully cancelled, you may request deletion of your information as follows:</b></span>
				...
				<div id="totalFields" style="display:none">
					...
					<div id="email_fields">
					<rn:widget path="custom/ccc_form/TextInputCCC" name="Contact.Emails.PRIMARY.Address" required="true" initial_focus="false" label_input="#rn:msg:EMAIL_ADDR_LBL#" allow_external_login_updates="true"/>
					</div>

					<div id="phone_fields">
					<rn:widget path="input/TextInput" name="Contact.Phones.MOBILE.Number" label_input="Phone Number" required="false" allow_external_login_updates="true"/>
					</div>
					...
					<div id="opt_out_info" style="text-align:left; font-size:15px;display:none;"><b>If you would like to opt-out of tracking cookies set by third parties that may be considered "sales," you can opt-out through our cookie manager by clicking here: <a href ="#">OSANO Link</a>.</b></div>

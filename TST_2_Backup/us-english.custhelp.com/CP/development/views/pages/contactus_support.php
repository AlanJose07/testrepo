...
<form id="rn_ChatLaunchForm" method="post" action="">
		...
		<!--<div id="cat_level_3" style="display:block">
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Incident.c$free_text" label_input="Category level 3" default_value="#rn:php:$catid#">
		</div>-->

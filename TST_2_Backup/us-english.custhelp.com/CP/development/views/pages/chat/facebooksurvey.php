    ...
    <div id="rn_ChatContainer">
        <div id="rn_PageContent" class="rn_Live">
            <div class="rn_Padding">
					...
					<!-- <div id="rn_ChatDialogTitle" class="rn_FloatLeft">Please enter your question below.</div> -->
		...
		?>
			...
			<div id="rn_ChatDialogTitle" class="rn_FloatLeft">Sorry, Facebook Messenger is not available in your market. For available support options please go to your designated <a style="text-decoration: underline;" href="https://faq.beachbody.fr/app/contactus">Support Page</a>. </div>
			<? else: ?>
			<div id="rn_ChatDialogTitle" class="rn_FloatLeft">Sorry, Facebook Messenger is not available in your market. For available support options please go to your designated <a style="text-decoration: underline;" href="https://faq.beachbody.co.uk/app/contactus">Support Page</a>. </div>
			<? endif; ?>

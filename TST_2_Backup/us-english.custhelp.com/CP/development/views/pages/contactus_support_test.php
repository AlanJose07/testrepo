...
<form id="rn_ChatLaunchForm" method="post" action="">
		...
		<rn:widget path="custom/ResponsiveDesign/testchanneldisplay" name="Incident.c$recommended_channel" label_input="Member Type" required="false"/>
		</div>
		...
		<div class="overlay-form" id="self-service">
		 ...
		 <h1 id="email-title" style="display:none">Email Support</h1>
		...
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Contact.Emails.PRIMARY.Address"  label_input="Email" required="true"/>
		</div>
		<div id="email-details" style="display:none">
		<div id="first-name" style="display:none">
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Contact.Name.First"  label_input="First" required="true"/>
		</div>
		
		<div id="last-name" style="display:none">
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Contact.Name.Last"  label_input="Last" required="true"/>
		</div>
		</div>
	...
	<rn:widget path="custom/ResponsiveDesign/Language" name="Incident.c$language_shk" label_input="Preferred Response Language" default_value="1182" interface=1 required="true"/>
		</div>
...
function redirect_from_email()
{
	 ...
	 window.location="https://faq.beachbody.com/app/home";
	 var a = document.body;
...
<rn:widget path="custom/Chat_Hidden_Fields/ChatTextInput" name="Contact.Emails.PRIMARY.Address"  label_input="Email" required="false"/>
<rn:widget path="custom/Chat_Hidden_Fields/ChatTextInput" name="Contact.Name.First"  label_input="First" required="false"/>
<rn:widget path="custom/Chat_Hidden_Fields/ChatTextInput" name="Contact.Name.Last"  label_input="Last" required="false"/>

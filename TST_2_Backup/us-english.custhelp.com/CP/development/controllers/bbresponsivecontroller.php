	 ...
	 function iframe_log()
	  {
		...
		$text = "\n".$text;
		error_log($text,3, '/cgi-bin/us_english.cfg/scripts/cp/customer/development/views/pages/error_log/iframe_nice.txt');
	  } 

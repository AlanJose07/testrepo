...
class nusoap_client extends nusoap_base
{
     ...
     * @access   public
     */
    function init($endpoint = 'https://faq.beachbody.com/euf/assets/wsdl/fedex/OpenshipService_v17.wsdl', $wsdl = 'wsdl', $proxyhost = false, $proxyport = false, $proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30, $portName = '')
    {

    ...
    */
    ...
    _onReportChanged: function(type, args) {
        ...
        if(newdata.total_num > 0) {
			...
			//by jithin
			///$('.rn_NoResults').css('display','block');
			///var fff=document.getElementsByClassName("rn_NoResults");
			//var shadesEl = document.querySelector('.rn_NoResults');
			//shadesEl.classList.add('jpjjpj');   
			//alert("11");
			//console.log(shadesEl);
			//above code by jithin
		...
		/*********************************************************************************************************************/
		/*The below code is to remove the flickering effect. The difference between the document and window, the div with class inner-nav is assigned to a hidden field          stickyclass_hide_show(This field is present in the template) */
		/*Once this field is set from the nav.js file(under responsive/themes/js) window.scroll function is called and the corresponding changes applied in that section*/
		/*********************************************************************************************************************/
		/*var doc_height1=$(document).height();
		alert(doc_height1);
		var win_height1=$(window).height();
		var doc_win_diff1=doc_height1-win_height1;
		alert(doc_win_diff1);
		document.getElementById("stickyclass_hide_show").value=doc_win_diff1+"-"+$('.inner-nav').height();*/

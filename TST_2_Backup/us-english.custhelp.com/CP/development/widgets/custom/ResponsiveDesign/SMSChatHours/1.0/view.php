	...
	if(array_key_exists($i,$arr_duplicates))
	{
		...
		{	
			...
			/*-----------------------------------convert to 12 hour---------------------------------------------*/
				...
				{
				echo $this->day_order($start)." - ".$this->day_order($end).":  "."Text is not available<br/>";
				}
		   ...
		   else if($start)
		   {
			...
			$string2=rtrim($string2,', ');
				...
				{
				echo $this->day_order($start).": "."Text is not available<br/>";
				}
		   }
		   else
		   {
		   echo $this->day_order($i).": "."Text is not available<br/>";
		   }

...
class CustomOrder extends \RightNow\Models\Base
{
   ...
   function __construct()
	...
	//echo $id;
		if(  $id == 2)
		{
			$flv = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", "customFields.c.current_flavor"); 
			$m=0;
	...
	{
		$flv = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", $field_name);
		$len = count($flv); 
		$m=0;
...
die('--------------------------------------------');*/
						...
						$menuitems = RNCPHP\ConnectAPI::getNamedValues('RightNow\Connect\v1_4\Incident','CustomFields.c.current_flavor');
						...
						{
						$date = $field->value;
							$datevalues = RNCPHP\ConnectAPI::getNamedValues('RightNow\Connect\v1_4\Incident','CustomFields.c.current_ship_day');
					 ...
					 if ($field->name == "Contact.Name.First") 
						...
						{
						$member = $field->value;
							$membertypes = RNCPHP\ConnectAPI::getNamedValues('RightNow\Connect\v1_4\Incident','CustomFields.c.member_type');
				...
				/*	if($incident->Threads[2]->Text)
					{
					 ...
					 $flavor = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", "customFields.c.flavor1");
	...
	$language = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", "customFields.c.ccc_language");
	...
	if($id=='23')
	$countrylan_hide_id= array('751','753');
    if($id=='null')
	...
	$language = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", "CustomFields.c.shk_orders");
	...
	$language = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Incident", "CustomFields.c.language_shk");  
	$countrydetails=array();
	...
	{
		$flv = RNCPHP\ConnectAPI::getNamedValues("RightNow\\Connect\\v1_4\\Update_Acnt\\Update_Account_Info", $field_name);

   ...
   function __construct($attrs) {
    ...
    function getData() {
		...
		if (!empty($cat_id))
		{
		 ...
		 $query="select BB.categ_contac_hom_ca from BB.categ_contac_hom_ca where BB.categ_contac_hom_ca.category.ID=".$cat_id." and BB.categ_contac_hom_ca.interface.ID=2 and BB.categ_contac_hom_ca.visible_on_page.ID in(3,4) and BB.categ_contac_hom_ca.enable=1";  
		}

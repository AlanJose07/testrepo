       ...
       RightNow.Event.subscribe("on_before_ajax_request", this._onBeforeAjaxRequest, this);
        ...
        if (!responseObject) { 
			...
			if(country_id==2)//canada
			{
				...
				document.getElementById("errors").innerHTML +=	"<div><b><a href='/app/contactus_support/catid/1749/catname/Track-My-Order/ans_sec/8443/TLP/1702.All-Orders-(Other-Nutritionals,-DVDs,-and-Apparel)' target='_blank' >Chat</a> <span>for assistance</span></b></div>";
	      ...
	      if(responseObject[i].order_status_id == 2 || responseObject[i].order_status_id == 6)
		  {
			...
			*/
			...
			if((track_id=="" || track_id== null) && (diffDays > 6 ))//different popup content
			{
				 ...
				 heading +="<div class='multiple_order' id='block_"+i+"'style='display:none;'><div>We"+"'"+"ve noticed your order "+responseObject[i].order_number+" for "+responseObject[i].product+" placed on "+responseObject[i].order_create_date+" has not shipped.</div> <div> <a href='/app/contactus_support/catid/1749/catname/Track-My-Order/ans_sec/8443/TLP/1702.All-Orders-(Other-Nutritionals,-DVDs,-and-Apparel)' target='_blank'>Chat</a> for assistance.</div></div>";

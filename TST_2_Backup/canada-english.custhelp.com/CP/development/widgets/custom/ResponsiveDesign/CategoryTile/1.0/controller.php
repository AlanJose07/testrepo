...
class CategoryTile extends \RightNow\Libraries\Widget\Base {
    ...
    function getData() {
		...
		if($text->count()>0)
	   {
		...
		{
		 $query="select BB.categ_contac_hom_ca from BB.categ_contac_hom_ca where BB.categ_contac_hom_ca.visible_on_page.ID=".$page_id." and BB.categ_contac_hom_ca.enable=1 and BB.categ_contac_hom_ca.interface.ID=".$interface_id." ORDER BY BB.categ_contac_hom_ca.display_order";  
		}
		else                // else condition for the contact us flow
		{
		 
		 $query="select BB.categ_contac_hom_ca from BB.categ_contac_hom_ca where BB.categ_contac_hom_ca.visible_on_page.ID=".$page_id." and BB.categ_contac_hom_ca.category.Parent.ID=".$cat_id." and BB.categ_contac_hom_ca.enable=1 and BB.categ_contac_hom_ca.interface.ID=".$interface_id." ORDER BY BB.categ_contac_hom_ca.display_order";
		}

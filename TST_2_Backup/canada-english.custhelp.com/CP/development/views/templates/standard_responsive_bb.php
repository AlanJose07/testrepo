...
<head>
	...
	<!-- Decibel - https://faq.beachbody.ca/ -->
...
<!-- Decibel -  faq.beachbody.ca End here -->
...
<body class="v-scroll">
	...
	<!-- Hotjar Tracking Code for https://faq.beachbody.ca/ --> 
	<script> 
	(function(h,o,t,j,a,r){ h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
	 h._hjSettings={hjid:2675638,hjsv:6}; a=o.getElementsByTagName('head')[0];
	  ...
	  <div class="login-btn-custom sign-in">
        ...
        <nav>
          <ul>
            ...
            <li><a href="https://coach.teambeachbody.com/enca/signin-ca" onClick="click_tracking('Menu Links - Coach Office')">Coach Office</a></li>
            <li><a href="https://www.teambeachbody.com/shop/ca/coach?locale=en_CA&destPage=coach" onClick="click_tracking('Menu Links - Become Coach')">Become a Coach</a></li>
            ...
            <li><a href="https://www.teambeachbody.com/shop/ca/b" onClick="click_tracking('Menu Links - Shop')">Shop</a></li> 
			...
			<span class="c-button c-button--dropdown js-dropdown__current"><img src="/euf/assets/themes/responsive/images/ca.png" id="selectedFlag">CANADA (ENGLISH)</span>
...
$(document).ready(function(){
		...
		policyLink.attr('href', 'https://www.teambeachbody.com/shop/ca/privacy?locale=en_CA');

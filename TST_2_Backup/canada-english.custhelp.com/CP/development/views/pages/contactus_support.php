...
<form id="rn_ChatLaunchForm" method="post" action="">
		...
		<div class="overlay-form" id="self-service">
		 ...
		 <h1 id="doc-title" style="display:none">Submit a Document</h1>
		 ...
		 <h1 id="call-me-now-title" style="display:none">Call Me Now</h1>
		...
		<rn:widget path="custom/ResponsiveDesign/TextInput" name="Incident.c$coachcustomernumber" label_input="Coach ID" required="true"/>
		</div>  
	...
	<rn:widget path="custom/ResponsiveDesign/Language" name="Incident.c$language_shk" label_input="Preferred Response Language" default_value="1182" interface=2 required="true"/>
		</div>  
		</div>
		...
		L'option de chat en Fran&ccedil;ais n'est pas disponible pour le moment. Veuillez r&eacute;essayer plus tard, ou s&eacute;lectionnez l'option en Anglais pour recevoir de l'aide maintenant.
		 ...
		 <rn:widget path="custom/ResponsiveDesign/SpanishChatHour" label_chat_hours ="Chat en fran&ccedil;ais" />  
		 </div>
...
<rn:widget path="custom/ResponsiveDesign/PhoneHourDetails" interface=2/>
</div>
   ...
   <!-- <span class="close" onClick="closePopUp()"  style="display: none">X</span>-->
	...
	<div id="formdisplay" style="display: none">
		...
		<form id="form" onsubmit="return false">
				...
				<div class="country">
				<rn:widget path="custom/ResponsiveDesign/countrySelectionInput_ccu" name="Contact.Address.Country" required="true" label_input = "Country" default_value='2' allow_external_login_updates="true"/>
				</div>

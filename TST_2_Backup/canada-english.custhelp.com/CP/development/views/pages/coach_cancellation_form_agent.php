...
<div id="rn_PageContent" class="">
	<?php 
			...
			$seedData->in_global_text_Country = "CA";
			$seedData->in_global_text_locale = "en_CA";
			
			$seedDataJson = json_encode($seedData);
			
	?>
	<rn:widget path="custom/opa/OPAWidget" policy_model = "Coach_Cancellation_Form_Agent"  web_determinations_url = "https://beachbodyopa.custhelp.com/web-determinations" init_id = "" locale="en-CA"  seed_data=#rn:php:$seedDataJson#/>
</div>

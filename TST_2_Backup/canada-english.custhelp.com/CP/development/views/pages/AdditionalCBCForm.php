...
<div id="rn_PageContent" class="">
	...
	<rn:widget path="custom/opa/OPAWidget" policy_model ="Additional-CBC-Form" web_determinations_url =  "https://beachbodyopa.custhelp.com/web-determinations" init_id = "" locale="en-CA"  seed_data=#rn:php:$seedDataJson#/>

...
$datalog = "---------------".$_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
//error_log($datalog,3, '/cgi-bin/canada_english.cfg/scripts/cp/customer/development/views/pages/error_log/emptyncpage.txt');
//if(empty($incidentid))
//error_log($datalog,3, '/cgi-bin/canada_english.cfg/scripts/cp/customer/development/views/pages/error_log/emptyncincident.txt');
?>
...
"> 
        ...
        <div class="chatwindowcontainre">
            <iframe src="https://home-c35.nice-incontact.com/inContact/ChatClient/ChatClient.aspx?poc=<?php echo $nice_chat_poc;?>&bu=4599337&p1=<?php echo $incidentid;?>&p2=<?php echo $catid;?>&p3=<?php echo $chatskill;?>&p4=<?php echo $fname;?>&p5=<?php echo $lname;?>&p6=<?php $thread;?>" id="iframe_id" class="iframeclass"></iframe>
        </div>
    </div>
...
/*$(document).ready(function() {
    ...
    var res = iframeReference ? new URL(iframeReference.src) : undefined;
	var iframeUrl = encodeURI(res);
    if (iframeUrl) {
        console.log("URL: " + iframeUrl);
		$.ajax('/cc/bbresponsivecontroller/iframe_log', {
					type: 'POST',  // http method
					async: false,
					data: { iframeUrl: iframeUrl },  // data to submit

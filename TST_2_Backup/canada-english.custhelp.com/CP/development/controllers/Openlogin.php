...

{
 ...
 /**
	...
	logmessage("_authorizeBeachbody");
            ...
            $parameters = array(
                'client_id'=>'095ab27d-d3e9-45d4-8811-562bab71754d',
				'redirect_uri'=>'https://canada-english--tst2.custhelp.com/cc/openlogin/oauth/callback/beachbody',
	...
	$redirect_rul=urlencode("https://canada-english--tst2.custhelp.com/cc/openlogin/oauth/callback/beachbody");
	$count = 0;
	 if($requestToken){
	 load_curl();
	 $code_verifier = $this->session->getSessionData('code_verifier');
	 ...
	 //$error_url = '/app/signing'; header('Location: ' . $error_url); exit;
          ...
          while($count < 3){
            //get FB access token
           $response = $this->client->post('https://loginuat.beachbody.com/03ed5554-4840-327e-9346-6e5c74000000/login/token', array(
                'code' => $requestToken,
                'client_id' => '095ab27d-d3e9-45d4-8811-562bab71754d',

	...
	function track_contact_clicks($home_link,$mob)
		{
			...
			$answerhit->curr_address = "https://faq.beachbody.ca/app/contact_us/lob/".$path[$line_of_business+1];
			...
			$answerhit->answer_view_action = "Contact Us Form CA";
			if($mob == 5)
			{
				$var = "Contact Us Form CA";
...
function track_shk_clicks($home_link,$mob)
		{
			...
			if($mob == 1)
			{
			$answerhit->clicked_link = "Shakeology Form Mobile";
			}
			else if($mob == 0)
			{
		...
		function track_order_status_clicks($home_link,$mob)
		{
			...
			$answerhit->curr_address = "https://faq.beachbody.ca/app/home/lob/".$path[$line_of_business+1];
		...
		function track_call_support($home_link,$mob)
		{
			...
			$answerhit->curr_address ="https://faq.beachbody.ca/app/answers/detail/a_id/9909/~/beachbody-support-contact-information/lob/".$path[$line_of_business+1];
		...
		function track_contactus_clicks($home_link,$mob)
		{
			...
			$answerhit->curr_address = "https://faq.beachbody.ca/app/answers/detail/a_id/9909/~/customer-service-%26-coach-relations-contact-information/lob/".$path[$line_of_business+1];

    ...
    <div id="rn_ChatContainer">
        ...
        <div id="rn_PageContent" class="rn_Live">
            <div class="rn_Padding">
					...
					<div id="rn_SmsTitle" class="rn_FloatLeft">Veuillez vous connecter pour utiliser la fonction Appelez-moi.</div>
					</rn:condition>
		...
		<rn:condition logged_in="true">
				...
				<div id="rn_SmsTitle" class="rn_FloatLeft"><?php echo "Bonjour ".$this->session->getProfile()->first_name->value.", veuillez confirmer votre numéro avant de commencer." ?></div>
				 <script>
				...
				<div id="phone" style="display:block;position:sticky !important;" class="is-completed">
			...
			<!--<div id="agent-help" style="display:block">
				...
				<rn:widget path="input/SelectionInput" name="Incident.c$form_routing" label_input="" default_value="1983">
				</div>
				
				<div id="contactchannel-routing" class="contactchannel-routing" style="display:none">
				<rn:widget path="input/SelectionInput" name="Incident.c$contact_channel" label_input="" default_value="1474">
				</div>
				...
				Votre compte est maintenant vérifié et vos sélections seront utilisées pour vous servir plus rapidement. Cliquez sur « Appelez-moi » et le prochain agent disponible vous aidera.

				
				</div>
									
				<div id="submit-button" style="display:block;text-align:center;">
				<rn:widget path="custom/ResponsiveDesign/Submit" label_button="Appelez-moi" error_location="rn_errorlocation_chat" on_success_url='/app/home'/>	
				</div>
				<div id="sms-rates" style="text-align:left !important;padding-bottom:30px !important;">
				
				Veuillez vérifier que votre téléphone autorise les appels de numéros inconnus.

				
				</div>	
		
			<div style="font-size:15px !important;color:#1378DD;text-align:center;">
				<p id="myPopup" class="pointer">#rn:msg:CUSTOM_MSG_GENERAL_PHONE_NUMBER#</p>	
			</div> 
...
<div class="modal-content Bb_modal">
  ...
  <div id="headingOrder"></div>    
   ...
   Nous vous recommandons d’utiliser la fonction « Appelez-moi » pour obtenir une assistance plus rapide. Un agent sera en mesure de vous aider en fonction des choix que vous aurez effectués.</p>
   <p style="font-size: 16px;text-align:left;">
   Si vous préférez appeler le Service à la clientèle de Beachbody, on vous posera une série de questions afin de vérifier votre identité et on vous demandera de choisir des options dans notre menu.  </p>
   <p style="font-size: 16px;text-align:left;">
...
window.onload = function(e){ 
	...
	document.getElementById("rn_Submit_12_Button").removeAttribute("disabled"); 

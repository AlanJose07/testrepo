...
<div id="rn_PageContent" class="">
	<?php 
			...
			*/
			...
			$seedData->in_global_text_locale = "fr_CA";
	...
	<rn:widget path="custom/opa/OPAWidget" policy_model = "Coach_Cancellation_Form"  web_determinations_url = "https://beachbodyopa.custhelp.com/web-determinations" init_id = "" locale="fr-CA"  seed_data=#rn:php:$seedDataJson#/>

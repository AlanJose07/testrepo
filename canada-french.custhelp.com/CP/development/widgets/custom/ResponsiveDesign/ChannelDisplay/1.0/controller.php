   ...
   function __construct($attrs) {
    ...
    function getData() {
		...
		if (!empty($cat_id))
		{
		 ...
		 $query="select BB.categ_contac_hom_fr from BB.categ_contac_hom_fr where BB.categ_contac_hom_fr.category.ID=".$cat_id." and BB.categ_contac_hom_fr.interface.ID=30 and BB.categ_contac_hom_fr.visible_on_page.ID in(3,4) and BB.categ_contac_hom_fr.enable=1";  
		}

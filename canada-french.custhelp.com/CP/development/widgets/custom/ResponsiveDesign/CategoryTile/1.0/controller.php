...
class CategoryTile extends \RightNow\Libraries\Widget\Base {
    ...
    function getData() {
		...
		if($text->count()>0)
	   {
		...
		{
		 $query="select BB.categ_contac_hom_fr from BB.categ_contac_hom_fr where BB.categ_contac_hom_fr.visible_on_page.ID=".$page_id." and BB.categ_contac_hom_fr.enable=1 and BB.categ_contac_hom_fr.interface.ID=".$interface_id." ORDER BY BB.categ_contac_hom_fr.display_order";  
		}
		else                // else condition for the contact us flow
		{
		 
		 $query="select BB.categ_contac_hom_fr from BB.categ_contac_hom_fr where BB.categ_contac_hom_fr.visible_on_page.ID=".$page_id." and BB.categ_contac_hom_fr.category.Parent.ID=".$cat_id." and BB.categ_contac_hom_fr.enable=1 and BB.categ_contac_hom_fr.interface.ID=".$interface_id." ORDER BY BB.categ_contac_hom_fr.display_order";
		}

    ...
    <div id="rn_ChatContainer">
        <div id="rn_PageContent" class="rn_Live">
            <div class="rn_Padding">
					...
					<div id="rn_ChatDialogTitle" class="rn_FloatLeft">Please sign-in to proceed with facebook messenger.<!--#rn:msg:CHAT_LBL#--></div>
					</rn:condition>
	    ...
	    <rn:widget path="custom/ResponsiveDesign/Language" name="Incident.c$language_shk" label_input="Preferred Response Language" 
		 default_value="1182" interface=2 required="true"/>
		</div>
		...
		?>
			...
			<div id="rn_ChatDialogTitle" class="rn_FloatLeft">Sorry, Facebook Messenger is not available in your market. For available support options please go to your designated <a style="text-decoration: underline;" href="https://france-french--tst2.custhelp.com/app/contactus">Support Page</a>. </div>
			<? else: ?>
			<div id="rn_ChatDialogTitle" class="rn_FloatLeft">Sorry, Facebook Messenger is not available in your market. For available support options please go to your designated <a style="text-decoration: underline;" href="https://uk-english--tst2.custhelp.com/app/contactus">Support Page</a>. </div>
			<? endif; ?>
		...
		//echo "<pre>";
		//print_r($contact->Address->Country->ID);

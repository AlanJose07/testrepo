RightNow.namespace('Custom.Widgets.ResponsiveDesign.OverridedOpenLogin');
Custom.Widgets.ResponsiveDesign.OverridedOpenLogin = RightNow.Field.extend({ 
    /**
     * Widget constructor.
     */
...
overrides: {	 
    ...
    */
    _goToUrl: function(inputValue) {
        ...
        goToUrl.call(this, this.data.attrs.controller_endpoint);
    },

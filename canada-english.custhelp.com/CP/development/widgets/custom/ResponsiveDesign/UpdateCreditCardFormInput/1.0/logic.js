RightNow.namespace('Custom.Widgets.ResponsiveDesign.UpdateCreditCardFormInput');
Custom.Widgets.ResponsiveDesign.UpdateCreditCardFormInput = RightNow.Widgets.extend({ 
    /**
     * Widget constructor...
     */

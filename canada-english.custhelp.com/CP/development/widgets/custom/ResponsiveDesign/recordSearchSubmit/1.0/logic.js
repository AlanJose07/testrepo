...
Custom.Widgets.ResponsiveDesign.recordSearchSubmit = RightNow.Widgets.FormSubmit.extend({ 
    ...
    overrides: {
        ...
        if (!responseObject) {
			...
			document.getElementById("errors").innerHTML +=	"<div><b><a href='/app/contactus_support/catid/1773/catname/Update-Credit-Card/ans_sec/7660/TLP/1703.My-Account' target='_blank' >Chat</a> <span>for assistance</span></b></div>";

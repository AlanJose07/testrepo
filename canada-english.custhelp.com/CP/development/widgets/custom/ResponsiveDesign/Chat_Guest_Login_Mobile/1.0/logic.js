...
Custom.Widgets.ResponsiveDesign.Chat_Guest_Login_Mobile = RightNow.Widgets.extend({ 
    ...
    constructor: function(data, instanceID) {
		...
		//var pta_login = RightNow.Interface.getConfig("PTA_EXTERNAL_LOGIN_URL");
		...
		list.addEventListener("click", function(e) {
			...
			RightNow.Ajax.makeRequest('/cc/bbresponsivecontroller/loginsession', {text:login_url}, {
                    successHandler: function(response) {
						...
						{ 
						window.location = 'https://canada-english--tst2.custhelp.com/cc/openlogin/oauth/authorize/beachbody?returnurl=chat/prechatsurvey/'+url_parameter;
						}

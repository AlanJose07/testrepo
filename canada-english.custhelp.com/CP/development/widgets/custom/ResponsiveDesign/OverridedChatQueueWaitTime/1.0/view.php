<? /* Overriding ChatQueueWaitTime's view */ ?>
<div id="rn_<?=$this->instanceID;?>" class="<?= $this->classList ?> rn_Hidden">
	...
	<span id="rn_<?=$this->instanceID;?>_QueuePositionLabel" class="rn_ChatQueuePosition rn_Hidden">
        #rn:msg:CUSTOM_MSG_QUEUE_POSITION_LABEL#
    </span>

...
<? if(($item["DirectlyRTM"]=="null") and ($item["SelfServiceForm"]=="null") and ($item["AgentChat"]=="null") and ($item["Email"]=="null") and ($item["Phone"]=="null") and ($item["Facebook"]=="null") and ($item["SMS"]=="null") and ($item["Doc"]=="null") and ($item["CallMeNow"]=="null") and ($item["text"]=="null")) :?>
...
<? if($this->data['attrs']['page']=="2" and $this->data['attrs']['interface']=="2") :?>

 
		<? $categ_id=$this->data['categ_id']; ?>
		<? $cat_id_name=$this->data['categ_id'].".".$this->data['cat_nme'];?>
		
		<rn:widget path="custom/ResponsiveDesign/Popular_answer_count" static_filter="c=#rn:php:$cat_id_name#" report_id="143146"/> 
